...
[Dizin](README.md) · [Entegrasyon](09_SITE_ENTEGRASYONU.md) · [Ham envanter](arastirma__yerel-corpus.json)
...
Kaynaklar: [orchestrator](../src/components/dokumantasyon/preview/cad-runtime-orchestrator.tsx), [Studio](../src/components/dokumantasyon/studio/document-studio-shell.tsx), [dosya sayfası](../src/app/dokumantasyon/dosya/[fileId]/page.tsx).
...
| Yetkili dosya açma | [page.tsx](../src/app/dokumantasyon/dosya/[fileId]/page.tsx) | `getAdminFileAccess`; şu anda `searchParams` sözleşmesi yok |
...
| Paylaşım | [public route](../src/app/p/[token]/page.tsx) | Ayrı share akışı; admin erişimi public yetki yerine kullanılamaz |
