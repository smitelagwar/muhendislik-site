      ...
      {isOpen ? (
        <>
          ...
          <div
            ...
            className="fixed right-0 top-0 z-[101] flex h-full w-[84%] max-w-sm flex-col border-l border-border bg-zinc-950 shadow-2xl"
          >
              ...
              <div className="space-y-2">
                {MOBILE_NAV_ITEMS.map((item) => (
                  <Link
                    ...
                    href={item.href}
                    onClick={toggleMenu}
                    className="group flex items-center justify-between rounded-2xl border border-transparent bg-card/60 p-3 transition-colors hover:border-amber-400/25 hover:bg-card"
                  >
