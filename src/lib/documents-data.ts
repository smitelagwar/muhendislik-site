...
export const DOCUMENTS: DocumentItem[] = [
  {
    ...
    fields: [
      { key: "tutanak_alt_baslik", label: "Tutanak Alt Başlığı / Yapı Bilgisi", placeholder: "Örn: 120 Konut Projesi A Blok Radye Temel Dökümü" },
      { key: "tarih", label: "Döküm Tarihi", placeholder: "Örn: 16.08.2026", type: "text" },
      { key: "yer", label: "İl / İlçe / Şantiye Mahalli", placeholder: "Örn: Kadıköy / İstanbul - 1245 Ada 12 Parsel" },
      { key: "yibf", label: "YİBF Numarası", placeholder: "Örn: 1845920" },
      { key: "olay_aciklamasi", label: "Dökülen Yapı Elemanı ve Beton Sınıfı", placeholder: "Örn: 3. Kat Kolon-Kiriş-Döşeme C35/45 Hazır Beton Dökümü (Toplam 180 m³)", type: "textarea" },
      { key: "gozlem_notlar", label: "Gözlem ve Kalite Kontrol Notları", placeholder: "Örn: Slump 16 cm ölçüldü, vibratör kesintisiz uygulandı, 6 adet küp numune alındı.", type: "textarea" },
      { key: "laboratuvar", label: "Laboratuvar Teknik Elemanı", placeholder: "Ad Soyad - Belge No" },
      { key: "muteahhit", label: "Müteahhit / Yetkili Temsilci", placeholder: "Firma / Yetkili Adı Soyadı" },
      { key: "santiye_sefi", label: "Şantiye Şefi", placeholder: "Ad Soyad - Oda Sicil No" },
      { key: "yapi_denetim", label: "Yapı Denetim Yetkilisi", placeholder: "Ad Soyad - Denetçi No" },
    ],
    defaultValues: {
      tutanak_alt_baslik: "Radye Temel ve Bodrum Perdeleri Beton Dökümü",
      tarih: new Date().toLocaleDateString("tr-TR"),
      yer: "İstanbul / Kadıköy - 1024 Ada 8 Parsel",
      yibf: "",
      olay_aciklamasi: "Zemin Kat Taşıyıcı Sistem Elemanları C35/45 sınıfı hazır beton dökümü gerçekleştirilmiştir.",
      gozlem_notlar: "Kalıp ve donatı kontrolleri yapılmış, paspayları kontrol edilmiş ve betoniyer slump değeri 16 cm olarak uygun bulunmuştur.",
      laboratuvar: "",
      muteahhit: "",
      santiye_sefi: "",
      yapi_denetim: "",
