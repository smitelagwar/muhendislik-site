...
Yerel kaynak/kurulu paket incelemesi: [02](02_REPO_INCELEMESI.md). Dosya hash/başlık/lexical DXF sayımı: [corpus](arastirma__yerel-corpus.json). Başlangıç dosya koruması: [fingerprint](arastirma__yerel-baslangic.json). Kullanıcı tarafından sağlanan öneri: [orijinal](girdi__SOL_TEKNIK_ONERILER_ORIJINAL.md).
