...
export function HomeHeroSection() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1440px] px-5 pb-8 pt-10 sm:px-8 sm:pt-14 lg:px-12 lg:pb-10 lg:pt-14 xl:px-16">
        <div className="grid items-center gap-8 lg:min-h-[500px] lg:grid-cols-12 lg:gap-8">
          <div className="relative z-10 lg:col-span-5">
            ...
            <HomeSearchTrigger className="home-search-trigger mt-7 w-full max-w-xl" />
