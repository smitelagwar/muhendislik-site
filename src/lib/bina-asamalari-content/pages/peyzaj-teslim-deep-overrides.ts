...
const PEYZAJ_TOOLS: BinaGuideTool[] = [
  { category: "Olcum", name: "Total station, lazer nivo ve drenaj kontrol listesi", purpose: "Acik alan kotlarini, yüzey egimlerini ve su yonunu sayisal olarak dogrulamak." },
  ...
  { category: "Bakim", name: "Bitkisel bakım ve mevsimsel takip plani", purpose: "Teslim sonrasi ilk bakim surecini isletme ekibine okunabilir halde devretmek." },
  { category: "Kontrol", name: "Acil alan kullanimi ve yaya rotasi checklisti", purpose: "Acik alanin yalniz estetik degil guvenli kullanim performansini da denetlemek." },
];
...
const PEYZAJ_EQUIPMENT: BinaGuideEquipment[] = [
  ...
  { group: "Uygulama", name: "Bordur, parke, beton yol ve zemin sıkıştırma ekipmanlari", purpose: "Acik alan yüzeyini tasiyici ve düzgün hale getirmek.", phase: "Sert zemin imalati" },
  ...
  { group: "Teslim", name: "Bakim klasoru, bitki listesi ve garanti kayitlari", purpose: "Isletme ekibine bakım ve yenileme bilgisini düzenli devretmek.", phase: "Kapanis" },
];
...
export const peyzajTeslimDeepOverrides: BinaGuidePageSpec[] = [
  {
    ...
    kind: "topic",
    quote: "Peyzaj ve cevre duzenleme, bina cevresini guzellestirmekten once suyu, erisimi ve acik alan kullanimini dogru yonetme isidir.",
    tip: "Dis sahayi sadece son gorsel dokunus gibi gormek, ilk yagmurda ortaya cikacak kot, golenme ve erisim sorunlarini gizlemekten baska bir sey degildir.",
    intro: [
      "Peyzaj ve cevre duzenleme, bir yapinin kullaniciyla ilk fiziksel temas kurdugu alandir. Yaya akslari, girisler, sert zeminler, bordurler, yesil alanlar, sulama ve acik alan mobilyalari burada bir araya gelir. Kullanici binayi gormeden once çoğu kez dis sahayi deneyimler; bu nedenle acik alan performansi, yapinin genel kalite algisinin parcasidir.",
      "Sahada en sik yapılan hata, peyzaji santiyenin sonunda kalan dekoratif paket gibi ele almaktir. Oysa dis saha; yagmur suyunun nereye gittigini, aracin nerede durdugunu, engelli veya cocuklu bir kullanicinin nasıl ilerledigini ve bakim ekibinin bu alanlari nasil yonetecegini belirler. Yani mesele bitki secmekten daha büyüktür.",
      "Bir insaat muhendisi icin peyzaj ve cevre duzenleme; kot, egim, sikistirma, drenaj, altyapi koordinasyonu ve teslim sonrasi bakim bilgisinin birlikte kapatildigi son saha paketidir. Bu paket zayif kaldiginda bina fiziksel olarak bitmis görünse bile kullanima hazir görünmez.",
      "Bu nedenle dis sahayi son anda tamamlanan bir estetik kalem yerine, projenin acik alan performansini tanimlayan teknik kapanis fazi olarak okumak gerekir.",
    ],
    theory: [
      "Dis saha performansinin ana belirleyicisi su yonetimidir. Sert zemin dogru egimde degilse, bordur ve ızgara kotlari uyumlu degilse veya alt temel suyu saglikli tasimiyorsa en pahali kaplama bile kısa surede cökme, golenme veya kirlenme problemi uretir. Yuzeyde gorunen kusur çoğu zaman altyapı problemidir.",
      "Bitkisel peyzaj tarafında da benzer bir durum vardir. Bitki secimi kadar toprak derinligi, sulama altyapisi, drenaj ve mevsimsel bakim planı kritiktir. Sadece dikilen ama yasatilmayan peyzaj, teslim aninda güzel görünse de ilk mevsim degisiminde kalite kaybeder. Bu nedenle peyzajın teknik başarısı, dikim gunu değil sonraki bakım senaryosuyla ölçülür.",
      "Açik alanlar aynı zamanda güvenlik ve erişim alanlarıdır. Giris rampasi, yaya yolu, otopark geçişi, acil durum erişimi ve gece kullanımı birlikte çözülmelidir. Yüzey kaplamasinin kayma davranışı, kot farklarının yönetimi ve aydınlatma ile yönlendirme elemanları bu performansin ayrılmaz parçasıdır.",
      "Bu yüzden peyzaj ve cevre duzenleme, mimari çizimde renkli tarama olarak görülen bir tema değil; su, zemin ve kullanıcı hareketinin birlikte yönetildigi açık alan mühendisliğidir.",
    ],
    ruleTable: [
      {
        ...
        note: "Dis sahada yanlış kot, binaya dogru su basma riskini büyütür.",
      },
      {
        parameter: "Alt temel ve sikistirma",
        limitOrRequirement: "Sert zemin kaplamasi tasiyici alt temel ve yeterli sikistirma uzerine kurulmalı",
      ...
      },
      {
        ...
        note: "Bakım bilgisi devredilmeyen dis saha, yarim teslimdir.",
      },
    ],
    designOrApplicationSteps: [
      "Bina giris kotlari ile dis saha kotlarini tek modelde okuyup suyun akacagi yönleri kesinleştir.",
    ...
    criticalChecks: [
      "Giris ve yaya yollarinda suyu yapıya geri iten ters egim var mi?",
    ...
    numericalExample: {
      ...
      steps: [
        ...
        {
          title: "Kullanici etkisini yorumla",
        ...
        },
        {
          ...
          note: "Aksi halde yüzey dogru görünse bile su en zayif detaya birikir.",
        },
      ],
      checks: [
      ...
      engineeringComment: "Dis sahada birkaç santimetrelik kot farki, kullanicinin yıllarca yaşayacağı su davranisini belirler.",
    },
    tools: PEYZAJ_TOOLS,
    equipmentAndMaterials: PEYZAJ_EQUIPMENT,
    mistakes: [
      { wrong: "Peyzaji yalnız bitki ve kaplama seçimi gibi görmek.", correct: "Kot, drenaj ve erisim performansini ana karar olarak ele almak." },
    ...
    designVsField: [
      ...
      "Dis saha ne kadar iyi tasarlanırsa tasarlansin, eger kot ve altyapi düzgün kurulmamissa ilk yagmur kalite testini başarısız geçirir.",
      "Bu nedenle cevre duzenleme, mimari son dokunus degil işleyen açık alan sistemi üretme işidir.",
    ],
    conclusion: [
      "Peyzaj ve cevre duzenleme dogru kot, dogru altyapi ve dogru bakım devri ile yürütüldüğünde yapının açık alan performansını güvenli ve uzun ömürlü hale getirir. Aynı alan bu disiplinler kurulmadan tamamlanırsa sorun ilk mevsim değişiminde görünür olur.",
      "Saha tarafinda en sağlam yaklaşım, dis sahayi son dakika kapanan dekoratif kalem değil, teslimin en görünür fonksiyon testi olarak yönetmektir. Bu bakış, hem kullanıcı memnuniyetini hem de teslim sonrasi bakım maliyetini doğrudan etkiler.",
    ],
    sources: [...PEYZAJ_DEEP_SOURCES, SOURCE_LEDGER.planliAlanlar, SOURCE_LEDGER.imarKanunu],
    keywords: ["peyzaj ve cevre duzenleme", "dis saha kotu", "drenaj", "sert zemin", "teslim ve bakım"],
