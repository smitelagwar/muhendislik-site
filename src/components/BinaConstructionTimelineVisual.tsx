...
function TopicCard({
  ...
  return (
    <article className={`group/card col-span-12 min-w-0 ${className}`}>
      <Link
        href={node.url}
        className="relative block h-full overflow-hidden rounded-[24px] border border-slate-200/90 bg-white shadow-sm transition duration-300 hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-xl dark:border-white/[0.08] dark:bg-white/[0.035] dark:hover:border-white/[0.16] dark:hover:bg-white/[0.055] dark:hover:shadow-black/25"
      >
      ...
      {hasChildren && (
        <>
          <button
            ...
            className="mt-2 flex w-full items-center justify-center gap-1.5 rounded-xl py-2 text-[11px] font-semibold text-slate-500 transition hover:bg-slate-100 hover:text-slate-800 dark:text-white/30 dark:hover:bg-white/[0.045] dark:hover:text-white/60"
          >
            <ChevronDown
