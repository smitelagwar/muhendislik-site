...
export function PublicShareDownloadView({
  ...
  return (
    <div className="mx-auto max-w-4xl w-full space-y-6">
      ...
      <div className="rounded-2xl border border-border/80 bg-card/95 p-6 shadow-2xl backdrop-blur-xl sm:p-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="shrink-0">
            <Button
              ...
              className="w-full sm:w-auto gap-2 bg-amber-500 px-6 py-6 text-sm font-bold text-zinc-950 shadow-lg hover:bg-amber-400 rounded-xl"
            >
              {downloadingZip ? (
                <>
      ...
      <div className="overflow-hidden rounded-2xl border border-border/80 bg-card/95 shadow-lg backdrop-blur-md">
        <div className="border-b border-border/60 bg-secondary/30 px-6 py-3.5 text-xs font-bold uppercase tracking-wider text-muted-foreground">
              ...
              >
                <div className="flex items-center gap-3.5 min-w-0 pr-4">
                  ...
                  <div className="min-w-0">
                    <div className="font-bold text-sm text-foreground truncate max-w-sm sm:max-w-md">
                      {item.snapshot_name}
                    </div>
                    <div className="text-[11px] text-muted-foreground truncate">
                      ...
                      <span className="font-mono font-medium">{formatBytes(item.snapshot_size_bytes)}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <Button
                    ...
                    className="gap-1.5 text-xs font-bold text-amber-600 dark:text-amber-400 hover:bg-amber-500/10 rounded-xl h-9"
                  >
                  ...
                  <Button
                    ...
                    className="gap-1.5 border-border/80 text-xs font-bold hover:border-amber-500/40 hover:bg-amber-500/10 hover:text-foreground rounded-xl h-9"
                  >
                    {isDownloading ? (
