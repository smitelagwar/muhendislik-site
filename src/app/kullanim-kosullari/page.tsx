        ...
        <div className="mx-auto max-w-5xl px-6 py-12 md:py-20">
            ...
            <div className="mt-10 rounded-3xl border border-zinc-200 bg-zinc-50 p-8 dark:border-zinc-800 dark:bg-zinc-900/60">
                <p className="text-sm leading-7 text-zinc-600 dark:text-zinc-400">
                    Sorularınız için <a className="font-bold text-blue-600 hover:underline dark:text-blue-400" href="mailto:info@insablog.com">info@insablog.com</a> adresi üzerinden bizimle iletişime geçebilirsiniz.
                </p>
            </div>
        </div>
    );
