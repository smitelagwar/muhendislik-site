...
const targets = [
  { slug: "otopark-kullanim-turune-gore-minimum-alan-hesabi", expected: "85 m²" },
  { slug: "otopark-rampa-egimi-genislik-donus-yaricapi", expected: "6,50 m" },
  { slug: "otopark-kapali-havalandirma-co-konsantrasyonu", expected: "10 hava değişimi" },
  { slug: "otopark-yapisal-yuk-kombinasyonlari-arac-deprem", expected: "TS 498" },
  { slug: "otopark-elektrikli-arac-sarj-mevzuati", expected: "23 Mart 2026" },
];
    ...
    for (const theme of ["light", "dark"]) {
      for (const viewport of viewports) {
        ...
        try {
          ...
          assert(result.links.some((href) => href.includes("csb.gov.tr") || href.includes("resmigazete.gov.tr") || href.includes("afad.gov.tr")), `${target.slug}: resmî kaynak linki görünmüyor.`);
