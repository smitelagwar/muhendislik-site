...
const TS_EN_13813_SOURCE: BinaGuideSource = {
  ...
  type: "standard",
  url: "https://www.tse.org.tr/",
  note: "Epoksi altligi olacak şap ve alt zemin kalitesinin yorumlanmasinda kullanilan temel standart eksenlerinden biridir.",
};
...
const EPOXY_TOOLS: BinaGuideTool[] = [
  ...
  { category: "Kontrol", name: "Katman kalinlik takibi ve ortam sıcaklık-nem cizelgesi", purpose: "Sistemin yalnız surulmus değil doğru kosulda uygulanmis oldugunu gostermek." },
...
const EPOXY_EQUIPMENT: BinaGuideEquipment[] = [
  { group: "Alt zemin", name: "Beton veya şap altlik, çatlak tamir harci ve lokal onarim malzemeleri", purpose: "Kaplamanin tasiyacagi yuzeyi düzgün ve taşıyıcı hale getirmek.", phase: "Hazirlik" },
...
export const inceIslerFloorBatchDeepOverrides: BinaGuidePageSpec[] = [
  {
    ...
    intro: [
      "Epoksi kaplama; otopark, endustriyel alan, laboratuvar, depo, teknik hacim ve hijyenik mahallerde sık kullanilan derzsiz zemin sistemlerinden biridir. Kolay temizlenmesi, kontrollu doku secenekleri, kimyasal dayanım ve yoğun trafik altinda servis verebilmesi onu cazip hale getirir. Ancak sahadaki gercek basari, son katin renginde veya parlakliginda değil; alt yuzeyin bu sistemi gercekten tasiyip tasiyamadiginda gizlidir.",
      "Şantiyede epoksi kaplama cogu zaman son dakikada giren bir 'parlatma' kalemi gibi algilanir. Bu bakis hatalidir. Cunku epoksi, boya gibi kusuru orten bir katman değil; kusuru oldugu gibi yukariya tasiyan ince bir performans sistemidir. Nemli beton, zayif şap, tozlu yüzey, iyi tamir edilmemis çatlak veya yetersiz mekanik hazirlik varsa sistem kısa surede kabarma, soyulma, baloncuk veya yerel kopmalar uretir.",
      "Bir inşaat mühendisi için epoksi kaplama yalnız ince iş konusu degildir. Alt betonun kacinci gunde oldugu, saha kuruma kosullari, beton sinifi, lokal tamirlerin kalitesi, zemin derzleri ve kullanima acma takvimi birlikte okunmalidir. Cunku epoksinin performansi, alt yapının ne kadar disiplinli tamamlandigiyla doğrudan baglantilidir.",
      "Bu yazida epoksi kaplamayi; teorik aderans mantigi, standart ekseni, sayisal nem ve katman yorumu, araçlar, malzemeler ve saha hatalariyla birlikte tam blog yazisi derinliginde ele aliyoruz. Amac, epoksiyi son kat estetik karar değil; zemin performans muhendisligi olarak okumak.",
    ],
    theory: [
      "Epoksi sisteminin teorik temeli, alt zemin ile kaplama arasinda hem mekanik hem kimyasal bir bag kurmasidir. Bu bag ancak beton veya şap yeterince saglam, temiz ve uygun purlulukte ise calisir. Yüzey sutunun kaldirilmasi, tozun tamamen uzaklastirilmasi ve gevsek bolgelerin temizlenmesi bu nedenle sadece hazirlik değil, sistemin omurgasidir. Mekanik hazirlik zayifsa, iyi recine bile saglam yapisamaz.",
      "Nem konusu epoksinin en kritik davranislarindan biridir. Beton icindeki serbest su veya alttan gelen kapiler nem, kaplama altinda buhar basinci ureterek kabarma ve aderans kaybi dogurabilir. Üst yüzey kuru gibi gorunse bile alt tabakada nem tutulabilir. Bu nedenle epoksiye gecmeden önce nemin cihazla ve kayitla dogrulanmasi gerekir; göz karariyla verilen onay, bu sistemde pahali hatadir.",
      "Katman kurgusu da doğrudan kullanım sinifina baglidir. Hafif yaya trafigi olan teknik mahal, forklift giren depo, kimyasal temizlige maruz laboratuvar ve otopark aynı sistemi istemez. Bazilarinda ince sealer tipi çözüm yeterli olabilirken bazilarinda quartz dolgulu, kaymaz ve daha kalin yapili sistem gerekir. Epoksi secimi bu nedenle renk katalogu değil, servis sinifi kararidir.",
      "Catlaklar ve derzler ayri bir mühendislik konusudur. Mevcut yapisal catlagi yalnız recine ile uzerinden gecmek, problemi estetige indirmek olur. Hareket eden derzler, kontrol derzleri ve yapisal çatlaklar farkli çözüm ister. Epoksi katman hareketi absorbe etmeyen kisimlarda sadece kusuru görünür hale getirmez; aynı zamanda daha genis alanlara yayabilir.",
      "Son olarak saha lojistigi unutulmamalidir. Epoksi tamamlandiktan sonra erken trafik, tozlu ortam, baska ekiplerin calismaya devam etmesi veya uygunsuz temizlik bile sistemi bozabilir. Bu nedenle epoksi kaplama yalnız uygulama değil, uygulama sonrasi alan koruma ve devreye alma planidir.",
    ],
    ruleTable: [
      {
        parameter: "Alt zemin saglamligi ve hazirligi",
        limitOrRequirement: "Beton veya şap, tozdan arindirilmis, taşıyıcı ve mekanik hazirligi tamamlanmis durumda olmalidir",
        reference: "TS EN 1504-2",
        note: "Parlak ama zayif bir yüzey epoksi için uygun kabul edilmez.",
      },
      {
        parameter: "Nem kontrolü",
        limitOrRequirement: "Kaplama öncesi alt zemin nemi urun sisteminin izin verdigi esiklerle doğrulanmalıdır",
      ...
      },
      {
        ...
        limitOrRequirement: "Epoksi altligi olacak şap, düzgün, catlaksiz ve yeterli yüzey dayanimina sahip olmalidir",
        reference: "TS EN 13813",
        note: "Zayif şap, iyi epoksiyi de kısa surede tasiyamaz hale getirir.",
      },
      {
      ...
      {
        parameter: "Kullanım acma süresi",
    ...
    designOrApplicationSteps: [
      ...
      "Alt betonu veya şapı nem, purluluk, dayanım ve çatlak acisindan test et; epoksiye gecmeden önce sorunlu bolgeleri teknik olarak onar.",
      "Shot blast, taslama ve vakum temizligi ile yüzey sutunu ve tozu tamamen uzaklastir; epoksiyi kirli yuzeye emanet etme.",
      "Astar, ara kat ve son kat sistemini mahal riskine göre sec; kaymazlik veya quartz serpme gibi ihtiyaclari renk seciminden önce belirle.",
      "Uygulama sirasinda ortam sicakligi, bagil nem ve katmanlar arasi bekleme pencerelerini kayda bagla.",
      "Kaplama sonrasi alan koruma, toz kontrolü ve trafik acma planini netlestir; diger ekiplerin zemine erken girisini engelle.",
    ],
    criticalChecks: [
      "Alt zemin nemi cihazla olculdu mu ve kayda baglandi mi?",
      "Yuzeyde parlak sut tabakasi, yag, toz veya gevsek bölge kaldi mi?",
      "Catlaklar hareketli mi, yapisal mi, yoksa yalnız yuzeysel mi; buna göre ayri çözüm uygulandi mi?",
      "Secilen epoksi sistemi gercek trafik ve kimyasal kullanima uygun mu?",
      "Katman kalinligi ve katlar arasi bekleme süresi sahada kontrol edildi mi?",
    ...
    numericalExample: {
      ...
      assumptions: [
        ...
        "Urun sistemi %4 nem ustunde uygulama için ilave çözüm istemektedir.",
      ...
      steps: [
        {
          ...
          note: "Gorunurde kuru yüzey, sistem için güvenli oldugu anlamina gelmez.",
        },
        {
          ...
          note: "Epoksi program baskisiyla zorlandiginda hata altinda gizlenir, ustunde değil.",
        },
        {
          title: "Mühendislik kararini bagla",
          result: "Ya kuruma süreci uzatilmali ya da sisteme uygun nem bariyerli bir kurguya gecilmelidir.",
          note: "Teslim tarihi, zeminin teknik gerceginden önce gelemez.",
        },
      ],
      checks: [
        "Nem olcumu tek noktada değil alan dagilimina göre tekrarlanmalidir.",
    ...
    mistakes: [
      ...
      { wrong: "Çatlak ve derzleri estetik kusur gibi ele almak.", correct: "Hareketli ve yapisal kusurlari ayri teknik detayla cozumlemek." },
    ...
    designVsField: [
      ...
      "Iyi epoksi kaplama parlamaktan önce saglam tutunur; kötü epoksi ise ilk darbede veya ilk buhar basincinda gercegini ortaya koyar.",
      "Bu nedenle epoksi, ince isler icinde belki de en fazla alt yapı kalitesine bagimli sistemlerden biridir.",
    ],
    conclusion: [
      "Epoksi kaplama doğru alt zemin, doğru sistem secimi ve doğru alan yönetimi ile uygulandiginda uzun omurlu, temizlenebilir ve teknik olarak guvenilir bir zemin sunar. Bu zincirlerden biri zayif oldugunda hata son katta değil butun sistemde kendini gosterir.",
      "Bir inşaat mühendisi için en saglam bakis, epoksiyi dekoratif parlaklik değil; beton altligin kabulunu zorunlu kilan bir performans kaplaması olarak gormektir.",
    ],
