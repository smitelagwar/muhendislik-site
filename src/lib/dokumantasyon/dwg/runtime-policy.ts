export const DWG_BROWSER_SOURCE_HARD_LIMIT_BYTES = 32 * 1024 * 1024;
export const DWG_BROWSER_DXF_HARD_LIMIT_BYTES = 64 * 1024 * 1024;
export const DWG_BROWSER_INITIAL_DXF_BUFFER_BYTES = 4 * 1024 * 1024;

export const DWG_BROWSER_CACHE_FETCH_TIMEOUT_MS = 20_000;
export const DWG_BROWSER_SOURCE_FETCH_TIMEOUT_MS = 25_000;
export const DWG_BROWSER_WORKER_TIMEOUT_MS = 35_000;
...
export const CAD_UPSTREAM_TOTAL_TIMEOUT_MS = 60_000;
