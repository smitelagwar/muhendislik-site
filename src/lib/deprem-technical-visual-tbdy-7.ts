...
function modalScaleCover(spec: DepremRolloutSpec) {
  const body = `<line x1="150" y1="520" x2="1040" y2="520" stroke="${NAVY}" stroke-width="4"/><rect x="285" y="285" width="150" height="235" rx="10" fill="${NAVY}" fill-opacity="0.14" stroke="${NAVY}" stroke-width="5"/><text x="302" y="565" class="label">Vmodal</text><line x1="180" y1="210" x2="980" y2="210" stroke="${CYAN}" stroke-width="5" stroke-dasharray="14 10"/><text x="820" y="185" class="accent">Referans</text><line x1="520" y1="390" x2="705" y2="255" stroke="${CYAN}" stroke-width="6" marker-end="url(#arrow)"/><rect x="735" y="235" width="180" height="285" rx="12" fill="${CYAN}" fill-opacity="0.10" stroke="${CYAN}" stroke-width="5"/><text x="758" y="565" class="accent">Ölçekli V</text><text x="570" y="355" class="accent">Ölçek</text>`;
