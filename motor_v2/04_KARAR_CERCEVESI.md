...
Bu belgedeki tercihlerin tamamı başlangıç önerisidir. Yeni veriler geldikçe [karar kaydı](sablonlar__KARAR_KAYDI.md) ile değiştirilebilir. Kullanıcının korumak istediği mevcut motor, deney sonuçlarından bağımsız kalır.
