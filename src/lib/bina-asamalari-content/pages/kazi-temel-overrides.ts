...
export const kaziTemelTopicOverrides: BinaGuidePageSpec[] = [
  {
    ...
    kind: "topic",
    quote: "Hafriyat, topragi kazmak degil; zemini, suyu ve komsu yapilari birlikte yoneterek temel için guvenli platform olusturmaktir.",
    ...
    intro: [
      "Hafriyat isleri, yapinin gorunmeyen ama en riskli başlangıç fazidir. Bu fazda verilen kot, egim, su ve tahkimat kararlarinin tamami sonraki temel imalatinin kalitesini ve komsu parsellerin guvenligini etkiler.",
      "Sahada en sık gorulen hata, kaziyi yalnız kazi makinesinin ilerleme hiziyle yonetmektir. Oysa hafriyat; aplikasyon, kademe plani, tasima rotasi, gecici drenaj ve guvenli çalışma sinirlarinin birlikte ele alindigi bir operasyon zinciridir.",
      "Bir insaat muhendisi için hafriyat, 'zemin cikarma' degil; geoteknik veri ile saha lojistigini aynı anda yonetme isidir.",
    ],
    theory: [
      "Kazinin davranisi zeminin cinsi, yeraltı suyu, komsu temel derinlikleri ve hava kosullariyla birlikte okunur. Aynı kot farki, sert kilde baska, gevek kumda baska risk davranisi üretir.",
    ...
    ruleTable: [
      {
        parameter: "Kazı kötü",
        limitOrRequirement: "Proje kötü aplikasyon ile surekli dogrulanmali, fazla kazı aninda raporlanmali",
    ...
    designOrApplicationSteps: [
      "Kazı öncesi aplikasyon, komsu parsel siniri ve gecici trafik planini netlestir.",
    ...
    criticalChecks: [
      "Kazı kötü proje kotuyla surekli dogrulaniyor mu?",
    ...
    numericalExample: {
      ...
      steps: [
        ...
        },
        {
          ...
          result: "Lokal bölge rastgele toprakla doldurulmamalidir; uygun dolgu veya zayif beton karari muhendislik kontroluyle verilmelidir.",
          note: "Kazida geri gelmek, kazmak kadar teknik bir islemdir.",
        },
        {
          title: "Takvime etkisini yorumla",
          result: "Fazla kazi grobeton ve donati takvimini doğrudan etkiler; aninda raporlanmalidir.",
    ...
    tools: [
      { category: "Ölçüm", name: "Total station, nivo ve kot kontrol cizelgesi", purpose: "Kazı derinligi ve platform dogrulugunu surekli izlemek." },
      ...
      { category: "Kayıt", name: "Kazı dibi kabul tutanagi ve foto arşivi", purpose: "Temel öncesi platformun teknik olarak devrini belgelemek." },
    ],
    equipmentAndMaterials: [
      ...
      { group: "Ölçüm", name: "Aplikasyon kaziklari, kot isaretleri ve ölçüm ekipmani", purpose: "Kazı sınırlarını ve derinligini surekli dogrulamak.", phase: "Takip" },
      ...
      { group: "Güvenlik", name: "Bariyer, ikaz elemanlari ve kenar koruma ekipmani", purpose: "Kazı cevresinde insan ve ekipman guvenligini saglamak.", phase: "Surekli" },
    ],
    mistakes: [
    ...
    designVsField: [
      ...
      "Iyi hafriyat sonraki ekibe sessiz bir platform birakir; kötü hafriyat temel imalatini daha baslamadan savunmada birakir.",
    ],
    conclusion: [
      "Hafriyat isleri doğru aplikasyon, doğru su kontrolu ve doğru saha gozlemi ile yonetildiginde temel fazinin guvenli baslangicini olusturur.",
      "Yanlış yonetildiginde ise kot, su ve komsu etki problemleri tüm projeye yayilan kayip uretir.",
    ],
  ...
  },
  {
    ...
    kind: "topic",
    quote: "Temel tipi secimi, katalog tercihi degil; zemin kapasitesi, oturma davranisi ve taşıyıcı sistemin birlikte verdigi bir muhendislik cevabidir.",
    tip: "Temel turunu sadece üst yapinin agirligina bakarak secmek, oturma farklarini ve saha uygulanabilirligini ikinci plana itmek demektir.",
    intro: [
      "Temel turleri; münferit, sürekli, radye veya kazikli sistemler gibi farkli cozumlerle üst yapidan gelen yukleri zemine aktaran ana ara yüzdür. Bu nedenle temel karari yalnız taşıyıcı sistem konusu degil, aynı zamanda geoteknik bir uyum karari olarak okunmalidir.",
      ...
      "Bir insaat muhendisi için temel tipi, zemin etudu, su seviyesi, komsu yapilar, kazı derinligi ve deprem davranisi ile birlikte karar verilen temel proje kararıdır.",
    ],
    theory: [
      "Temel seciminde ana soru, zeminin yalnız tasima gucu degil; toplam ve diferansiyel oturma davranisidir. Tasima gucu saglanmis görünen bir zeminde bile oturma farki üst yapida ciddi catlak ve servis problemi yaratabilir.",
      ...
      "Yeraltı suyu, zayif tabaka derinligi veya komsu yapı etkisi arttiginda kazikli cozumler ya da zemin iyilestirme ile desteklenen temeller gündeme gelir. Bu noktada proje karari yalnız statik degil, geoteknik ve ekonomik optimizasyon olur.",
      "Deprem etkisi altinda da temel sistemi üst yapinin davranisini etkiler. TBDY 2018, temel ve zemin davranisinin birlikte ele alinmasini bu nedenle ister.",
    ],
    ruleTable: [
      {
        parameter: "Temel secim kriteri",
        limitOrRequirement: "Tasima gucu, oturma, su seviyesi ve üst yapı duzeni birlikte degerlendirilmeli",
      ...
      },
      {
        ...
        note: "Temel sadece düşey yuk elemani gibi gorulmemelidir.",
      },
    ],
    designOrApplicationSteps: [
      "Zemin etudundeki tabaka, su ve oturma verilerini temel seciminin ana girdisi olarak oku.",
      "Kolon-perde duzeni ve üst yapı yuk dagilimini temel planı ile birlikte incele.",
    ...
    numericalExample: {
      ...
      inputs: [
        ...
        { label: "Yuk karakteri", value: "Perde + kolonlu orta yuk", note: "Çok katli konut varsayimi" },
    ...
    tools: [
      ...
      { category: "Kontrol", name: "Temel secim matrisi", purpose: "Zemin, su, kazi ve maliyet kriterlerini aynı tabloda gormek." },
    ...
    mistakes: [
      ...
      { wrong: "Saha lojistigini temel seciminden ayirmak.", correct: "Kazı, donati ve betonlama akisini secimin parçası yapmak." },
      { wrong: "Temeli sadece düşey yuk elemani gibi gormek.", correct: "Deprem davranisi ve temel-zemin etkilesimini de hesaba katmak." },
    ],
    designVsField: [
      ...
      "Doğru temel secimi sadece daha guvenli degil, daha okunabilir ve uygulanabilir bir şantiye uretir.",
    ],
    conclusion: [
  ...
  },
  {
    ...
    intro: [
      "Zemin etudu, yapinin zemine oturan tüm kararlarini besleyen temel veri setidir. Tasima gucu, tabaka siralamasi, yeraltı suyu, sikisma davranisi ve deprem parametreleri bu rapordan okunur; dolayisiyla raporun kalitesi tüm temel stratejisini belirler.",
      "Sahada en sık hata, raporu bir kez alip rafa kaldirmaktir. Oysa kazi sirasinda görülen tabaka farklari, su cikislari veya beklenmeyen gevsek zonlar raporla birlikte yeniden okunmali ve gerekirse proje karari guncellenmelidir.",
      "Bir insaat muhendisi için zemin etudu, sadece jeoloji verisi degil; tasarim, saha gozlemi ve risk yonetimi arasinda kurulan teknik dildir.",
    ],
    theory: [
    ...
    designOrApplicationSteps: [
      ...
      "Temel alti kabulden once geoteknik varsayimlarin sahada gecerli kaldigini tekrar doğrula.",
    ],
    criticalChecks: [
    ...
    numericalExample: {
      ...
      steps: [
        ...
        },
        {
          ...
          result: "Kazı sirasinda bu iki zon arasindaki geçiş mutlaka gozlenmeli ve tutanaklanmalidir.",
    ...
    equipmentAndMaterials: [
      ...
      { group: "Saha", name: "Kazı sirasinda tabaka gozlem ve ölçüm ekipmani", purpose: "Rapor verisini sahada tekrar dogrulamak.", phase: "Kazı" },
