  ...
  return (
    <div>
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={toggleMenu} className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm" />
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 z-[101] flex h-full w-[80%] max-w-sm flex-col bg-white shadow-2xl dark:bg-zinc-950"
            >
