...
const targets = [
  { slug: "engelsiz-tekerlekli-sandalye-manevra-alani-koridor-genislikleri", expected: "150 cm × 150 cm" },
  { slug: "engelsiz-rampa-egimi-korkuluk-yuzey-standartlari", expected: "1:20 (%5)" },
  { slug: "engelsiz-wc-asansor-kapi-boyutlari", expected: "1,80 m²" },
  { slug: "engelsiz-yapi-ruhsatinda-uyum-kontrolu", expected: "2026/1" },
];
...
try {
    ...
    for (const theme of ["light", "dark"]) {
      for (const viewport of viewports) {
        ...
        try {
          ...
          assert(result.links.some((href) => href.includes("aile.gov.tr") || href.includes("mevzuat.gov.tr") || href.includes("csb.gov.tr") || href.includes("resmigazete.gov.tr")), `${target.slug}: resmî/kamu kaynak linki görünmüyor.`);
  ...
  console.log(JSON.stringify({
    status: "ok",
    phase: "FAZ 6 batch 5 — Engelsiz Tasarım",
