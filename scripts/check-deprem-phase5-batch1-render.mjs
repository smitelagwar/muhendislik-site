...
const targets = [
  { slug: "byy-bina-kullanim-siniflari-tehlike-kategorileri", expected: "Madde 19" },
  { slug: "tasiyici-sistemlerin-yangina-dayanim-suresi-r30-r60-r90-r120", expected: "R120" },
  { slug: "sprinkler-sistemi-zorunluluk-sinirlari", expected: "600 m²" },
];
const viewports = [
