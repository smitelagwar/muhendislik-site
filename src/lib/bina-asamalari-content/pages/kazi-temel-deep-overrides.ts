...
const IKSA_TOOLS: BinaGuideTool[] = [
  ...
  { category: "Ölçüm", name: "Inklinometre, total station ve oturma pimi takip seti", purpose: "Duvar deplasmanini, komsu yapı davranisini ve kademe ilerleyisini veriyle izlemek." },
...
const IKSA_EQUIPMENT: BinaGuideEquipment[] = [
  { group: "Taşıyıcı", name: "Fore kazik, diyafram duvar veya palplanş çevreleme elemanlari", purpose: "Kazı cephesini ve komsu etkisini kontrollu sekilde tutmak.", phase: "Iksa kurulumu" },
...
export const kaziTemelDeepOverrides: BinaGuidePageSpec[] = [
  {
    ...
    kind: "topic",
    quote: "Iksa sistemi, kaziyi ayakta tutan gecici bir destekten daha fazlasidir; komsu yapilarin ve kazinin davranisini aynı anda yoneten aktif bir muhendislik paketidir.",
    tip: "Iksayi yalnız imalat kalemi gibi gormek, en kritik karari kacirmak demektir: sistemin gercek basarisi, her kademe kazida nasil davrandigini okuyabilmektir.",
    intro: [
      "Iksa sistemleri, derin kazilarda zemin hareketini sinirlamak, komsu yapilari korumak ve temel imalatina guvenli çalışma hacmi saglamak için kurulan ana geoteknik savunma katmanidir. Fore kazik, diyafram duvar, ankraj, iç destek veya palplans gibi cozumler farkli sahalarda farkli avantajlar uretir; ancak hepsinin ortak amaci kontrolsuz deformasyonu engellemektir.",
      "Sahada en sık yapilan hata, iksayi kazidan once kurulan ve sonra unutulan bir eleman gibi gormektir. Oysa iksa, kaziyla birlikte yasayan bir sistemdir. Her kademe ilerledikce yatay hareket, su etkisi, ankraj davranisi ve komsu parsellerin tepkisi yeniden okunmak zorundadir.",
      "Bir insaat muhendisi için iksa sistemi, yalnız geoteknik hesabın sonucu degil; saha gozlemi, deformasyon izleme, su kontrolu ve lojistik kararlarin ortak cikisidir. Duvarin teorik olarak yeterli cikmasi tek basina yetmez; sahada olculen hareketler o hesabın gercekle uyumunu test eder.",
    ...
    theory: [
      "Iksa davranisini belirleyen ana değişkenler zemin cinsi, kazı derinligi, yeraltı suyu, komsu yapı yükleri ve seçilen destek sistemidir. Aynı derinlikte iki kazı, zemin ve su koşulu degiştiğinde tamamen farklı deformasyon davranışı gösterebilir. Bu nedenle tek tip saha refleksi yerine projeye özgü izleme kültürü gerekir.",
      "Fore kazik veya diyafram duvar gibi çevreleme elemanlari yalnız kesitte duran rijit duvarlar degildir; arkalarindaki zeminin, onlerindeki kazı derinliginin ve ankraj ya da iç destek sisteminin ortak davranisi ile calisirlar. Duvar tek basina guvenli görunurken su basincinin ya da yetersiz ankraj gerilmesinin etkisiyle beklenenden fazla hareket edebilir.",
    ...
    mistakes: [
      ...
      { wrong: "Komsu yapilardaki küçük belirtileri göz ardi etmek.", correct: "Catlak, oturma ve kapi-pencere davranisini erken uyarı olarak okumak." },
