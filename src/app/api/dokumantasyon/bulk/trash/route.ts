// ============================================================================
// POST /api/dokumantasyon/bulk/trash — TOPLU ÇÖPE TAŞIMA
// ============================================================================
...
import { bulkTrashSchema } from "@/lib/dokumantasyon/validation";
import { trashFile } from "@/lib/dokumantasyon/files";
import { trashFolder } from "@/lib/dokumantasyon/folders";
...
export async function POST(request: Request) {
  try {
    ...
    const parseResult = bulkTrashSchema.safeParse(body);
    ...
    const message = err instanceof Error ? err.message : "Toplu silme sırasında hata oluştu.";
