...
function svgWrapper(title, category, categoryColor, content) {
  ...
  <g transform="translate(48, 44)">
    ...
    <text x="1018" y="37" fill="#94a3b8" font-family="system-ui, -apple-system, sans-serif" font-size="12" font-weight="700" text-anchor="middle">ŞANTİYE REHBERİ</text>
  </g>
  ...
  <g transform="translate(48, 605)">
    ...
    <text x="1104" y="24" fill="#64748b" font-family="system-ui, -apple-system, sans-serif" font-size="12" font-weight="600" text-anchor="end">ÖLÇEK: UYGULAMA VE KONTROL ŞEMASI</text>
  </g>
</svg>`;
}

export { targetDir, svgWrapper };
