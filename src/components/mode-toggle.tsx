...
export function ModeToggle() {
  ...
  return (
    <button
      ...
      className="relative inline-flex h-8 w-16 shrink-0 items-center rounded-full transition-all duration-500 ease-in-out bg-gradient-to-br from-sky-400 to-sky-300 dark:from-slate-900 dark:to-slate-800 overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-background shadow-[inset_0_2px_4px_rgba(0,0,0,0.2)] border border-sky-300/50 dark:border-slate-800/50"
    >
