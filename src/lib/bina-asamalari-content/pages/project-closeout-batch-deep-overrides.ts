...
const CLOSEOUT_TOOLS: BinaGuideTool[] = [
  ...
  { category: "Saha", name: "Kabul turu checklisti", purpose: "Ortak alan, yangin, tesisat ve çevre duzeninin tek turda denetlenmesini saglamak." },
  { category: "Resmi Süreç", name: "Iskan evrak takip cizelgesi", purpose: "Yapı kullanma izin surecindeki belge ve onay bagimliliklarini gormek." },
];
...
const CLOSEOUT_EQUIPMENT: BinaGuideEquipment[] = [
  ...
  { group: "Resmi Süreç", name: "Yapı kullanma izin evrak seti", purpose: "Iskan surecinde gereken onay ve teknik belgeleri eksiksiz toplamak.", phase: "Iskan" },
];
...
export const projectCloseoutBatchDeepOverrides: BinaGuidePageSpec[] = [
  {
    ...
    kind: "topic",
    quote: "Mimari proje, estetik kararlar paketi degil; tüm disiplinlerin oturacagi koordinat sistemini kuran ana teknik omurgadir.",
    tip: "Mimari projeyi yalnız plan ve gorunus seti gibi gormek, sahadaki en pahali revizyonlari daha proje hazirlik asamasinda davet eder.",
    intro: [
      "Mimari proje, bir yapinin yalnız gorunen yuzunu degil; taşıyıcı sistemi, tesisat rotalarini, yangin kacisini, cephe davranisini ve kullanıcı akisini aynı anda tanimlayan temel karar paketidir. Bu nedenle mimari proje yalnız mimarin sorumlulugunda kalan bir cizim seti degil, tüm disiplinlerin baglandigi ana referanstir.",
      "Sahada en pahali revizyonlarin buyuk bolumu eksik veya gec olgunlasmis mimari kararlardan dogar. Yanlış boyutlanan shaft, gec kesinlesen doğrama akslari, belirsiz parapet detayi veya kötü cozulmus islak hacim kurgusu; statik, mekanik ve elektrik ekiplerini ikinci kez tasarim yapmaya zorlar.",
      "Bir insaat muhendisi için mimari proje yalnız uygulama öncesi okunacak bir dosya degildir. Uygulama sirasini, aplikasyon kolayligini, saha lojistigini ve hatta teslim sonrasi bakım davranisini belirler. Yani iyi mimari proje, ofiste güzel gorunen degil; sahada daha az kirma, daha az dogaclama ve daha az tekrar iş ureten projedir.",
      "Bu yazida mimari projeyi; teorik koordinasyon mantigi, resmi gereksinimler, sayisal bir shaft ornegi, araç listesi ve sık yapilan hatalarla birlikte uzun-form ve sahada kullanilabilir bir rehber olarak ele aliyoruz.",
    ],
    theory: [
      "Mimari proje, disiplin koordinasyonunun ilk veri tabanidir. Akslar, cekirdekler, islak hacimler, doğrama bosluklari, cephe modulu ve kot iliskileri burada doğru kurulmadiginda statik ve tesisat disiplinleri cozum uretemez; yalnız uyarlama yapar. Bu da projenin ilerleyen asamalarinda zincirleme revizyon ve sahada yoruma acik detaylar dogurur.",
      "Mahal organizasyonu yalnız kullanıcı deneyimini degil; ekipman yerlesimini, yangin kacisini, acik sahada erisimi ve mekanik elektrik rotalarini da etkiler. Ornegin bir koridor genisligi veya shaft yeri mimari gorunmekle birlikte yangin senaryosu, tesisat gecisi ve bakım erisimi için de belirleyicidir. Bu nedenle mimari proje, mekan estetikleri kadar teknik bosluklar projesidir.",
      "Kabuk ve cephe kararlarinin da mimari projede yeterli olgunlukta kurulmasi gerekir. Doğrama akslari, denizlik, parapet, gunes kontrol elemanlari ve isi koprusu riski tasiyan birleimler erken cozulmezse uygulama paketi sahada uretilmeye baslar. Bu durum kaliteyi ustaya, maliyeti ise santiyeye birakir.",
      "Iyi mimari proje yalnız cizim uretmez; belirsizligi azaltir. Her karar sahadaki bir uygulama sirasini, bir detay uretimini veya bir imar-yangin uygunluk kontrolunu doğrudan etkiler. Bu nedenle mimari proje, proje hazirlik asamasinin en kritik muhendislik katmanlarindan biridir.",
    ],
    ruleTable: [
      {
      ...
      },
      {
        ...
        limitOrRequirement: "Dikey tesisat hacimleri, montaj ve bakım bosluklariyla birlikte overlay uzerinden dogrulanmalidir",
    ...
    designOrApplicationSteps: [
      ...
      "Shaft, islak hacim, merdiven, asansor ve teknik hacimleri yalnız yerlesim olarak degil montaj-bakım senaryosu olarak oku.",
      ...
      "Sahaya cikacak kritik detaylar için mahal bazli veya dugum bazli numune mantigi kur.",
    ],
    criticalChecks: [
    ...
    numericalExample: {
      title: "Shaft boyutunda montaj ve bakım boslugu yorumu",
      inputs: [
        ...
        { label: "Bakım boslugu hedefi", value: "25 cm", note: "Vana ve mudahale için asgari çalışma payi" },
      ],
      assumptions: [
        "Shaft aynı anda mekanik, elektrik ve yangin sistemlerine hizmet etmektedir.",
        "Sistemler üst uste degil, bakım yapilabilir mantikta zonlanacaktir.",
      ...
      steps: [
        {
          ...
          note: "Bu deger, yalnız borularin sigmasini degil bakım boslugunu da icerir.",
        },
        {
        ...
        },
        {
          ...
          result: "Mimari shaft kararinda yalnız eleman kesiti degil, montaj ve bakım boslugu da tasarim girdisidir.",
      ...
      checks: [
        ...
        "Bakım senaryosu yoksa shaft karari eksik kabul edilmelidir.",
    ...
    conclusion: [
      "Mimari proje doğru kuruldugunda tüm disiplinlerin uzerine oturdugu temiz bir koordinasyon zemini olusturur. Eksik olgunlastiginda ise sorun cepheden degil, tüm proje zincirinden geri doner.",
      "Bir insaat muhendisi için en kritik ders sudur: iyi mimari proje sahada güzel gorunen degil, daha az dogaclama ve daha az tekrar iş ureten projedir.",
    ],
  ...
  },
  {
    ...
    tip: "Iskani yalnız belediyeye teslim edilecek bir evrak isi gibi gormek, sahadaki eksikleri dosya kapanisiyla saklayabilecegini sanmaktir.",
    intro: [
      "Iskan ruhsati ya da yapı kullanma izin sureci, bir binanin yalnız fiziken tamamlandigini degil; onayli projeye, ortak alan guvenligine, teknik sistem devreye alma kayitlarina ve resmi uygunluk kosullarina göre kullanima hazir oldugunu gosteren son asamadir. Bu nedenle iskan, santiyenin sonundaki formalite degil; teknik kapanisin ana esigidir.",
      "Sahada iskan surecini zorlayan konularin buyuk kismi belediye masasnda degil, bina icinde dogar. Eksik as-built seti, devreye alma kaydi olmayan yangin sistemi, kapatilamamis punch list maddeleri, ortak alan imalatlarindaki sapmalar veya projeden kopmus son dakika degisiklikleri resmi sureci doğrudan kilitler.",
      "Bir insaat muhendisi için iskan sureci; teknik ofis, saha ve resmi kurum ucgeninde aynı anda yuruyen bir dogrulama isidir. Saha kapanisi, evrak kapanisi ve kullaniciya guvenli teslim birbirinden ayrildiginda bina bitmis gorunse bile gercek anlamda tamamlanmis sayilmaz.",
    ...
    theory: [
      "Iskan surecinin teorik omurgasi, onayli proje ile gercek saha uretiminin aynı sistem olarak okunmasidir. Ruhsat eki paftalar, yangin guvenligi, ortak alan kullanimi, erişim, teknik hacimler ve belediye kayitlari birbiriyle uyumlu degilse fiziksel tamamlanma tek basina yeterli olmaz. Bu nedenle iskan, yapinin dogrulugu ile dokumantasyonunun dogrulugunu aynı anda test eder.",
      "Teknik sistemler burada ozellikle kritik hale gelir. Yangin pompasi, algilama, asansor, jeneratr, temiz ve pis su sistemleri, ortak alan aydinlatmasi ve acil durum yonlendirmeleri yalnız monte edilmis olmamalidir; test edilmis, kayda baglanmis ve isletmeye devredilebilir durumda olmalidir. Iskan dosyasinda eksik kalan her teknik kayıt, sahadaki fiziksel tamamlanmaya ragmen sureci durdurabilir.",
      "As-built mantigi de aynı derecede onemlidir. Uygulama sirasinda yapilan her degisiklik belediye veya ilgili teknik onay zinciriyle uyumlu kayda baglanmadiysa, saha ile dosya arasinda fark birikir. En riskli durum da budur; cunku problem sahada yokmus gibi görünür ama resmi surecte bir anda onunuze gelir.",
      "Bu nedenle iskan ruhsati, belediyeye teslim edilmis belgeler toplami degil; santiyenin tüm kapanis mantiginin, ortak alan guvenliginin ve teknik sistem okunurlugunun sonucudur. Iyi yonetilen bir projede iskan dosyasi son hafta hazirlanmaz; tüm kapanis fazi boyunca olgunlasir.",
    ],
    ruleTable: [
      {
      ...
      {
        parameter: "Ortak alan ve kullanım guvenligi",
        ...
        note: "Iskan, bagimsiz bölüm kadar ortak alan performansini da sorgular.",
      },
      {
        parameter: "Teknik sistem devreye alma kayitlari",
        limitOrRequirement: "Yangin, asansor, enerji ve tesisat sistemleri için test, kabul veya devreye alma kayitlari eksiksiz tutulmalidir",
      ...
      },
      {
        ...
        limitOrRequirement: "Güvenlik ve resmi uygunluk etkili eksikler, kozmetik maddelerden once kapatilmalidir",
        reference: "Punch list yonetimi",
        note: "Teslim kalitesi, doğru ncelik sirasi ile kazanilir.",
      },
    ],
    designOrApplicationSteps: [
      ...
      "Ortak alan, giriş, rampa, kacis ve teknik hacim kabul turlarini tek tek degil, iskan mantigiyla butunsel yap.",
      "Yangin, asansor, enerji ve tesisat sistemleri için test-devreye alma kayitlarini punch list'ten bagimsiz bir kalite kapisi olarak yonet.",
      ...
      "Iskan basvurusu öncesi, teknik ofis ve saha ekibiyle bir son dosya-durum toplantisi yaparak acik riskleri kapat.",
    ],
    criticalChecks: [
      "Sahadaki son durum onayli projelerle gercekten uyumlu muc",
      "Yangin ve ortak alan guvenligi etkileyen eksik madde kaldi mic",
      "Asansor, yangin, jeneratr, pompa ve benzeri sistemler için test belgeleri eksiksiz mic",
    ...
    numericalExample: {
      ...
      steps: [
        ...
        },
        {
          ...
          note: "Belgeler adet olarak degil, sureci kilitleme etkisine göre degerlendirilmelidir.",
        },
        {
          title: "Muhendislik sonucunu bagla",
    ...
    mistakes: [
      { wrong: "Iskani santiyenin sonunda hazirlanacak bir evrak isi sanmak.", correct: "Kapanis fazi boyunca olgunlasan teknik süreç olarak yonetmek." },
      { wrong: "As-built cizimlerini son gune birakmak.", correct: "Saha degisikliklerini olustukca dosyaya islemek." },
      { wrong: "Yangin ve asansor kabul kayitlarini punch list kozmetigiyle aynı listede eritmek.", correct: "Kritik resmi uygunluk kalemlerini ayri onceliklendirmek." },
      ...
      { wrong: "Ortak alan eksiklerini bagimsiz bölüm tesliminden ayri dusunmek.", correct: "Iskan mantiginda ortak alan guvenligini ana kabul kriteri saymak." },
    ...
    designVsField: [
      "Kagit üzerinde bitmis bir dosya, sahada bitmis bina anlamina gelmez; ikisi aynı gercegi gosterdiginde iskan sureci saglikli ilerler.",
    ...
    conclusion: [
      "Iskan ruhsati sureci, onayli proje, saha kapanisi, ortak alan guvenligi ve teknik sistem belgeleri aynı hizda ilerlediginde sorunsuz tamamlanir. Bu halkalardan biri geride kaldiginda bina bitmis gorunse bile teknik olarak kapanmis sayilmaz.",
      "Bir insaat muhendisi için en saglam yaklasim, iskani belediye basvurusundan once saha-kalite dosyasi olarak tamamlamaktir.",
    ],
    ...
    keywords: ["iskan ruhsati", "yapı kullanma izin", "punch list", "as-built", "teknik kapanis"],
