...
const FINISH_EQUIPMENT: BinaGuideEquipment[] = [
  ...
  { group: "Birleşim", name: "Süpürgelik, esik profili, derz ve kenar bitis elemanlari", purpose: "Gecisleri ve kenar detaylarini temiz ve bakım dostu tamamlamak.", phase: "Bitis" },
...
export const inceIslerDeepOverrides: BinaGuidePageSpec[] = [
  {
    ...
    tip: "Parkeyi son kat estetik karari gibi görmek, nemli şap ve yanlış genlesme boşluğu gibi hatalari teslimden sonra kullanicinin ayagi altina birakmak demektir.",
    intro: [
      "Parke kaplama, konut ve ofislerde en yaygin tercih edilen zemin cozumlerinden biridir. Kullanıcı tarafinda yarattigi sıcaklık hissi, akustik konfor ve hızlı montaj avantajlari onu cazip kilar. Ancak şantiyede en çok sikayet uretebilen kaplamalardan biri olmasinin sebebi de tam olarak budur: hassas bir sistem olmasina ragmen basit gorulmesi.",
      "Bir inşaat mühendisi için parke isi yalnız urun secmek degildir. Sap nemi, mastar toleransi, altlik secimi, süpürgelik ve esik detaylari, mekanik veya islak hacimlerle sinir iliskisi ve teslim sonrasi koruma bir arada dusunulmelidir. Bu halkalardan biri eksik kaldiginda, kaliteli urun dahi kısa surede gicirdama, kalkma, kabarma veya birleşim acilmasiyla sorun uretir.",
      "Sahada parke ile ilgili en yaygin hatalar; yeterince kurumamis şap uzerine montaj, duvar diplerinde yetersiz genlesme boşluğu, geçiş detaylarinin plansiz cozulmesi ve montaj biter bitmez yuzeyin agir ekip trafigine acilmasidir. Bu hatalar ilk gun zararsiz gibi görünür; ama mevsim degisimleri ve gunluk kullanım basladiginda ortaya çıkar.",
      "Bu nedenle parke kaplamayi, katalogdan renk secilen son dokunus değil; nem, geometri ve hareket yönetimi isteyen teknik bir zemin sistemi olarak ele almak gerekir.",
    ],
    theory: [
      "Parke sistemleri, ozellikle laminat ve ahşap esasli urunler, cevresel neme ve sicakliga duyarlidir. Bu nedenle kaplama tek basina rijit ve sabit bir katman gibi davranmaz; kontrollu genlesme ve buzulme hareketleri gosterir. Duvar diplerinde ve esik gecislerinde birakilan boşluklar, bu hareketin emniyetli bicimde yonetilmesini sağlar.",
      "Alt zemin performansi burada belirleyicidir. Sap yeterince kuru degilse parkeye alttan nem yükler. Duzlemsizlik varsa parke altinda boşluk ve esneme olusur. Bu iki kosul birlikte oldugunda kaplama ilk basta düzgün gorunse bile kısa süre sonra birleşim acilir, yururken ses uretir veya lokalde yukselir. Yani parkedeki sorun cogu zaman parke yuzeyinde değil, alt sistemde başlar.",
      "Altlik ve buhar kesici secimi de yalnız aksesuar konusu degildir. Zeminle temas eden katmanda yanlış urun secildiginde hem akustik konfor hem de nem davranisi bozulur. Ozellikle döşeme alti tesisat, zemin ısıtma veya yeni dokulmus şap bulunan alanlarda bu karar daha kritik hale gelir.",
      "Ayrıca parke kaplamada iş programi çok önemlidir. Boya, sıva, mekanik duzeltme ve agir mobilya montaji bitmeden alana parke girdiginde yüzey ya kirlenir ya da darbe alir. Dolayisiyla parke isi, proje kapanis takviminde en sona yakin ama en disiplinli planlanmasi gereken imalatlardan biridir.",
    ],
    ruleTable: [
      {
        parameter: "Alt zemin nemi",
        limitOrRequirement: "Parke montaji öncesi şap nemi urun tipine uygun esik altinda olculerek dogrulanmali",
      ...
      },
      {
        ...
        limitOrRequirement: "Zemin duzlemselligi kaplamanin boşluk ve ses uretmeyecegi seviyede olmali",
      ...
      },
      {
        ...
        limitOrRequirement: "Duvar dibi, kolon, doğrama ve esiklerde sistemin hareketine izin verecek boşluk birakilmali",
    ...
    designOrApplicationSteps: [
      ...
      "Montajdan önce şap nemini ve yüzey duzlemini sayisal olcumle kontrol et; yalnız görsel kabul yapma.",
      "Altlik, buhar kesici ve genlesme bosluklarini sistemin ayrilmaz parçası olarak planla.",
      "Esik, kapı alti, süpürgelik ve farkli zemin geçiş detaylarini montaj başlamadan netlestir.",
      "Parke montajini diger kirli islerden ve agir ekip trafiginden ayiran bir iş sırası kur.",
    ...
    criticalChecks: [
      ...
      "Duvar dipleri, kolon cevresi ve esiklerde yeterli genlesme boşluğu birakildi mi?",
    ...
    numericalExample: {
      title: "36 m2 odada şap nemi ve malzeme hesabi yorumu",
      inputs: [
      ...
      steps: [
        {
          ...
          note: "Bu fark küçük gorunse de mevsimsel davranista önemli sonuc uretir.",
        },
        {
      ...
      checks: [
        ...
        "Fire payi oda geometrisi ve döşeme yonuyle birlikte degerlendirilmelidir.",
        "Alt zemin uygun degilse sorun parkede değil sahadaki hazirliktadir.",
        "Ölçüm aynı cihaz ve aynı yontemle tekrar edilerek teyit edilmelidir.",
      ],
      engineeringComment: "Parke kaplamada en kritik veri cogu zaman katalogdaki renk kodu değil, şap gercekten kuru mu sorusunun cevabidir.",
    },
    tools: FINISH_TOOLS,
    ...
    mistakes: [
      ...
      { wrong: "Duvar diplerinde genlesme boşluğu birakmamak.", correct: "Sistemin hareketini emniyetli yonetecek çevre bosluklarini tasarlamak." },
      ...
      { wrong: "Altlik secimini maliyet kalemi gibi görmek.", correct: "Akustik ve nem performansinin ana parçası olarak degerlendirmek." },
      { wrong: "Parke bitince alani hemen diger ekiplere acmak.", correct: "Koruma plani olmadan yuzeyi teslim etmemek." },
      { wrong: "Gicirdama ve küçük acilmalari kullanıcı sorunu gibi görmek.", correct: "Alt zemin ve montaj kalitesinin sonucu olarak erken safhada incelemek." },
    ],
    designVsField: [
    ...
    conclusion: [
      ...
      "Saha tarafinda en saglam yaklasim, parkeyi son kat estetik isi değil, alt zemin kabulu ve teslim korumasi isteyen teknik bir sistem olarak yonetmektir. Bu bakis, teslim sonrasi en sık gorulen kullanıcı sikayetlerini belirgin bicimde azaltir.",
    ],
    sources: [...INCE_DEEP_SOURCES, SOURCE_LEDGER.tsEn13329, SOURCE_LEDGER.ts825],
    keywords: ["parke kaplama", "şap nemi", "TS EN 13329", "genlesme boşluğu", "zemin kabulu"],
  ...
  },
  {
    ...
    kind: "topic",
    quote: "Duvar kagidi, kusuru orten bir kaplama değil; alt yüzey kalitesini ve detay disiplinini daha rafine bicimde görünür kilan bir testtir.",
    tip: "Duvar kagidini sadece desen secimi gibi görmek, en kritik iki konuyu kacirir: alt yüzey homojenligi ve ek yerlerinin isik altinda nasil gorunecegi.",
    intro: [
      "Duvar kagidi uygulamasi, konut, ofis ve ticari mekanlarda hızlı karakter kazandiran bir duvar kaplama cozumudur. Doku, desen ve renk cesitliligi sayesinde mekani guclu bicimde tanimlar. Ancak şantiyede en yanlış anlasilan ince islerden biri de yine duvar kagididir; cunku yüzey kusurlarini tamamen sakladigi sanilir.",
      "Oysa duvar kagidi, ozellikle isik alan yuzeylerde, alt yuzeyin homojenligini ve birleşim detaylarini son derece görünür hale getirir. Macun adasi, zimpara izi, tam kurumamis sıva, kötü astarlanmis yüzey veya sasmis ek yeri, boya uygulamasindan daha sert sekilde okunabilir.",
      "Bir inşaat mühendisi için duvar kagidi isi yalnız dekorasyon karari degildir. Yüzey nemi, sıva ve macun kabulu, ek yeri plani, elektrik anahtari-priz cevresi, köşe donusu ve teslim sonrasi koruma bir arada dusunulmelidir. Aksi halde uygulama ilk gun iyi gorunse bile kenar acilmasi, kabarma veya lekelenme ile sorun uretir.",
      "Bu nedenle duvar kagidini ince islerin estetik parçası kadar, alt yüzey kalitesinin teknik dogrulama katmani olarak görmek gerekir.",
    ],
    theory: [
      ...
      "Nem ve sıcaklık da kritik etkendir. Yeterince kurumamis sıva veya yeni tamir edilmis yuzeye uygulanan kagit zamanla kabarabilir. Islak hacimlere yakin duvarlar, dış cepheye yakin soğuk yuzeyler ya da pencere onu bolgeleri daha dikkatli degerlendirilmelidir. Duvar kagidi yalnız yuzeye yapismaz; arkasindaki yapı fizigi ile birlikte calisir.",
      "Ayrıca elektrik anahtari, priz, süpürgelik ustu ve tavan birleşimi gibi detaylar da duvar kagidinin algisini belirler. Uygulama yalnız duz duvar yuzeyinden değil, bu detaylarin nasil cozulddugunden de okunur. Bu nedenle duvar kagidi isi, detay odakli bir bitis muhendisligi olarak ele alinmalidir.",
    ],
    ruleTable: [
      {
        parameter: "Alt yüzey homojenligi",
        limitOrRequirement: "Sıva, macun ve astar katmanlari kagidin davranisini bozmayacak homojenlikte olmali",
      ...
      },
      {
        ...
        note: "Ek yeri sasmasi küçük alanda başlar, buyuk yuzde buyur.",
      },
      {
        ...
        note: "Duvar kagidinde kalite cogu zaman duz yuzde değil detay cizgisinde okunur.",
      },
      {
        parameter: "Teslim sonrasi koruma",
    ...
    designOrApplicationSteps: [
      "Duvar kagidi uygulanacak mekanlarda sıva, macun ve astar kabulunu boya standardindan da siki tut.",
      ...
      "Uygulama sirasinda düşey referansi sürekli kontrol et; bir seritteki küçük kaymayi sonraki seritlere tasima.",
    ...
    numericalExample: {
      ...
      checks: [
        "Duvar kagidinde serit hesabi yalnız alan hesabi değil, bitis ve isik hesabidir.",
        ...
        "Pratikte numune yerlestim, nihai uygulamadan önce kalite riskini azaltir.",
      ],
    ...
    mistakes: [
      ...
      { wrong: "Ek yerlerini isik yonunden bağımsız planlamak.", correct: "Dogal ve yapay isik etkisini bastan hesaba katmak." },
    ...
    designVsField: [
      ...
      "Iyi duvar kagidi uygulamasi kendini bagirarak değil, yuzeyin sessiz ve temiz gorunmesiyle belli eder.",
      "Bu nedenle duvar kagidi, dekoratif ama yüksek hassasiyet isteyen bir teslim katmanidir.",
    ],
    conclusion: [
      "Duvar kagidi doğru alt yüzey, doğru aks ve doğru detay çözümü ile uygulandiginda mekana hızlı karakter kazandiran çok etkili bir kaplama olur. Aynı iş hazirliksiz yurutuldugunde ek yeri, kabarma ve kenar acilmasi gibi kusurlari hemen görünür hale getirir.",
      "Saha tarafinda en doğru yaklasim, duvar kagidini estetik secim kadar teknik yüzey kabulu olarak görmek ve uygulama öncesi hazirligi buna göre yurutmektir. Bu bakis, teslim sonrasi kullanıcı algisini doğrudan iyilestirir.",
    ],
    sources: [...INCE_DEEP_SOURCES, SOURCE_LEDGER.tsEn13914],
    keywords: ["duvar kagidi", "ek yeri", "alt yüzey hazirligi", "desen plani", "duvar kaplaması"],
