...
**Durum:** Astra/kullanıcının karar kaydı şablonu; verilmiş karar değil. Gemini karar/seçim alanlarını dolduramaz veya yapıyı sadeleştirip kanıt alanlarını kaldıramaz. Gemini uygulama engellerini [CR şablonuyla](sablonlar__KARAR_ENGELI.md) iletir; [EXEC-1](00_BAGLAYICI_UYGULAMA_KARARLARI.md) revize edilmeden alternatif uygulanmaz.
