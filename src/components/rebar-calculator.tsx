      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] items-start">
          ...
          <div className="space-y-6">
            <section className="home-glass-panel rounded-[28px] border border-slate-200 dark:border-white/5 bg-white/80 dark:bg-slate-900/40 p-6 space-y-6 shadow-sm dark:shadow-2xl backdrop-blur-md">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div className="rounded-2xl border border-slate-200 dark:border-white/5 bg-slate-50/50 dark:bg-slate-950/20 p-4">
                  ...
                  <p className="mt-3 text-[11px] text-slate-500">
                    Tek çubuk alanı:{" "}
                    <span className="font-mono font-bold text-amber-600 dark:text-amber-400 font-sans">
                ...
                <div className="rounded-2xl border border-slate-200 dark:border-white/5 bg-slate-50/50 dark:bg-slate-950/20 p-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      className="h-12 w-12 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900/50 hover:bg-slate-100 dark:hover:bg-white/5 active:scale-95 transition-transform text-slate-700 dark:text-slate-300"
                    >
                    ...
                    <Input
                      ...
                      placeholder="Örn. 5"
                      className="h-12 flex-1 rounded-xl text-center text-base font-black bg-white dark:bg-white/5 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-white/10 focus:border-amber-400 focus:ring-1 focus:ring-amber-400 font-mono"
                    />
                    <Button
                      type="button"
                      variant="outline"
                  ...
                  <div className="mt-4 grid gap-4 sm:grid-cols-3 border-t border-slate-200 dark:border-white/5 pt-4">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className="h-10 rounded-lg text-xs font-mono font-bold bg-white dark:bg-white/5 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-white/10"
                      />
                    </div>
                    <div className="space-y-1.5">
              ...
              <div
                className={cn(
                  ...
                  ts500Check.status === "violated"
                    ? "bg-red-50 dark:bg-red-500/5 border-red-200 dark:border-red-500/20 text-red-900 dark:text-red-200"
                    : "bg-emerald-50 dark:bg-emerald-500/5 border-emerald-200 dark:border-emerald-500/20 text-emerald-900 dark:text-emerald-200"
                )}
              >
          ...
          <div className="lg:sticky lg:top-6 space-y-6">
            <section className="home-glass-panel overflow-hidden rounded-[28px] border border-slate-200 dark:border-white/5 bg-white/80 dark:bg-slate-900/40 p-6 space-y-6 shadow-sm dark:shadow-2xl backdrop-blur-md">
              {/* Canlı Sonuç Header */}
                ...
                {result ? (
                  <>
                    <div className="space-y-1 border-b border-slate-100 dark:border-white/5 pb-4">
                      <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block">Teorik Enkesit Alanı (As)</span>
                      <div className="flex items-baseline gap-2">
                        <span className="font-mono text-5xl font-black text-slate-900 dark:text-white tracking-tight tabular-nums">
                          {formatNumber(result.totalArea)}
                        </span>
                        <span className="text-base font-bold text-slate-500 dark:text-slate-400">mm<sup>2</sup></span>
                        <span className="text-sm font-bold text-amber-700 dark:text-amber-400 bg-amber-500/10 dark:bg-amber-500/5 px-2 py-0.5 border border-amber-500/20 dark:border-amber-500/10 rounded ml-2">
                          {formatNumber(result.totalArea / 100)} cm<sup>2</sup>
                        </span>
                      </div>
                      <p className="text-[11px] font-mono text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-transparent p-2.5 rounded mt-3 leading-relaxed">
                        {result.formula}
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider block">YERLEŞİM KROKİSİ</span>
                      <RebarSectionSketch
                        diameterMm={diameter}
                  ...
                  <div className="rounded-2xl border border-dashed border-slate-200 dark:border-white/5 p-8 text-center text-slate-500 dark:text-slate-400">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_0.9fr] items-start">
          ...
          <section className="home-glass-panel rounded-[28px] border border-slate-200 dark:border-white/5 bg-white/80 dark:bg-slate-900/40 p-6 shadow-sm dark:shadow-2xl backdrop-blur-md">
            ...
            {result ? (
                ...
                <Table>
                  <TableHeader className="bg-slate-50 dark:bg-slate-950">
                    <TableRow className="border-b border-slate-100 dark:border-white/5 hover:bg-transparent">
                      <TableHead className="text-slate-600 dark:text-slate-300 font-bold">Donatı Çapı</TableHead>
                      <TableHead className="text-slate-600 dark:text-slate-300 font-bold">Tek Çubuk</TableHead>
                      <TableHead className="text-slate-600 dark:text-slate-300 font-bold">Gerekli Adet</TableHead>
                      <TableHead className="text-slate-600 dark:text-slate-300 font-bold">Sağlanan Alan</TableHead>
                      <TableHead className="text-right text-slate-600 dark:text-slate-300 font-bold">Alan Fazlalığı</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {equivalentRows.map((row) => {
                      ...
                      return (
                        ...
                        >
                          <TableCell className="font-black text-slate-900 dark:text-white">
                            <div className="flex items-center gap-2">
                              ...
                              {isActive ? (
                                ...
                                <Badge className="rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400 group-hover:text-amber-700 dark:group-hover:text-amber-400 group-hover:border-amber-500/20 px-2 py-0.5 text-[9px] border border-slate-200 dark:border-white/5 transition-colors opacity-60 group-hover:opacity-100">
                                  SEÇ
                                </Badge>
                              )}
                            </div>
                          ...
                          <TableCell className="font-mono font-bold text-slate-900 dark:text-white tabular-nums">{row.quantity} adet</TableCell>
                          <TableCell className="font-mono font-bold text-amber-700 dark:text-amber-400 tabular-nums">{formatNumber(row.providedArea)} mm<sup>2</sup></TableCell>
                          <TableCell className="text-right font-mono font-semibold text-emerald-700 dark:text-emerald-400 tabular-nums">
              ...
              <div className="rounded-2xl border border-dashed border-slate-200 dark:border-white/5 p-6 text-sm text-slate-500 dark:text-slate-400">
          ...
          <section className="home-glass-panel rounded-[28px] border border-slate-200 dark:border-white/5 bg-white/80 dark:bg-slate-900/40 p-6 space-y-6 shadow-sm dark:shadow-2xl backdrop-blur-md">
            ...
            <div className="space-y-4">
              <div className="rounded-2xl bg-slate-50 dark:bg-white/5 p-4 border border-slate-100 dark:border-white/5">
                <p className="text-xs font-black uppercase tracking-wider text-amber-700 dark:text-amber-400">TS 500 Madde 7.4.1 (Aralık Sınırı)</p>
              ...
              <div className="rounded-2xl bg-slate-50 dark:bg-white/5 p-4 border border-slate-100 dark:border-white/5">
                <p className="text-xs font-black uppercase tracking-wider text-amber-700 dark:text-amber-400">TS 500 Denklem 7.1 (Çelik Alanı)</p>
