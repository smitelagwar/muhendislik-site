...
const STATIK_TOOLS: BinaGuideTool[] = [
  { category: "Analiz", name: "Idecad, ETABS veya benzeri taşıyıcı sistem yazilimlari", purpose: "Sistem davranisi, duzensizlik ve eleman iç kuvvetlerini tutarli modellemek." },
  ...
  { category: "Koordinasyon", name: "Mimari-statik-MEP overlay paftalari", purpose: "Shaft, bosluk, perde, kolon ve kiris cakismalarini saha öncesi gormek." },
...
const STATIK_EQUIPMENT: BinaGuideEquipment[] = [
  { group: "Dokumantasyon", name: "Hesap raporu, kalip planlari, donati paftalari ve detay sayfalari", purpose: "Taşıyıcı sistem kararlarini ofisten sahaya kayipsiz aktarmak.", phase: "Proje" },
  ...
  { group: "Saha baglantisi", name: "Dugum buyutme ciktisi, shop drawing ve numune imalat notlari", purpose: "Kritik birlesimlerin uygulamada kaybolmamasini saglamak.", phase: "Uygulama öncesi" },
];
...
export const projeHazirlikStatikDeepOverrides: BinaGuidePageSpec[] = [
  {
    ...
    theory: [
      ...
      "Bu nedenle statik proje uretiminde iki göz birlikte calismalidir: biri analitik dogrulugu, digeri saha mantigini temsil eder. Sadece ofis gozuyle cizilen proje fazlaca idealize olabilir; sadece saha gozuyle revize edilen proje ise standartlardan uzaklasabilir. Muhendislik kalitesi bu iki denetimin aynı paftada birlesmesiyle ortaya cikar.",
    ],
    ruleTable: [
      {
        parameter: "Yuk tanimlari ve on tasarim girdileri",
        limitOrRequirement: "Sabit ve hareketli yuk varsayimlari yapinin kullanimina göre TS 498 mantigi ile tutarli tanimlanmalidir",
        reference: "TS 498",
        note: "Yanlış yuk kabulu, daha ilk adimda eleman ve sistem kararlarini bozar.",
      },
      {
        parameter: "Deprem davranisi ve sistem duzensizlikleri",
        limitOrRequirement: "Taşıyıcı sistem secimi, duzensizlik kontrolu ve deprem etkileri TBDY 2018'in ilgili bolumleri ile uyumlu olmalidir",
    ...
    designOrApplicationSteps: [
      "Mimari aks, cekirdek, shaft ve cephe kurgusunu erken al; taşıyıcı sistem secimini bunlardan bagimsiz yapma.",
      ...
      "Perde, kolon, kiris ve doseme iliskisini yalnız program sonucuna göre degil, kat otelemeleri, donati yogunlugu ve bosluk ihtiyaci ile birlikte degerlendir.",
      "Kritik dugumlerde shop drawing mantigina yakin buyutmeler uret; ustanin yorumuna kalan belirsiz alan birakma.",
      "Temel sistemi secilirken zemin etudu, yuk dagilimi, deprem etkisi ve saha lojistigini birlikte oku; üst yapı karari ile temel kararini ayri ekiplerin sorunu gibi dusunme.",
    ...
    criticalChecks: [
      ...
      "Doseme ve kirisler için kontrolsuz sonradan delme ihtiyaci doguracak bosluk eksigi var mi?",
      "Temel tipi, zemin etudu ve üst yapı rijitlik dagilimi ile aynı muhendislik mantigini tasiyor mu?",
    ...
    numericalExample: {
      ...
      inputs: [
        ...
        { label: "Kat basi tasarim düşey yuk", value: "11 kN/m2", note: "Sabit + hareketli yuk için kaba on tasarim degeri" },
        { label: "Kat sayisi", value: "6", note: "Aynı yuk dagiliminin yaklasik kabul edildigi senaryo" },
      ...
      assumptions: [
        ...
        "Kaba kontrol için kolon kendi agirligi ve lokal duzensizlik etkileri ihmal edilmistir.",
      ],
      steps: [
        {
          title: "Bir katin kolona getirdigi düşey yuku bul",
          formula: "24 x 11 = 264 kN",
          result: "Kolonun bir katta tasidigi yaklasik düşey yuk 264 kN olarak okunur.",
        ...
        },
        {
          ...
          result: "Alt kat kolonunda yaklasik 1584 kN seviyesinde düşey yuk beklenir.",
      ...
      checks: [
        ...
        "Kolon kesiti, donati yerlesimi ve birlesim bolgesi okunurlugu için yeterli alan birakiyor mu?",
        "Perde ve kolon dagilimi yalnız eksenel yuk degil deprem davranisi acisindan da dengeli mi?",
    ...
    mistakes: [
      ...
      { wrong: "Mimari revizyonlardan sonra taşıyıcı sistem surekliligini yeniden sorgulamamak.", correct: "Aks ve duzensizlik etkilerini her buyuk revizyonda tekrar okumak." },
      ...
      { wrong: "Donati yogunlugu yuksek dugumleri kagit üzerinde cozulmus saymak.", correct: "Betonlanabilirlik ve vibrator erisimini saha gozuyle degerlendirmek." },
      { wrong: "Temel secimini üst yapidan bagimsiz ve sadece zemin raporuna birakmak.", correct: "Zemin verisini yuk dagilimi ve deprem davranisi ile birlikte okumak." },
    ...
    designVsField: [
      "Tasarim ofisinde statik proje tablo, model ve paftadan olusur; sahada ise aynı proje kalip sirasi, demir yogunlugu, beton yerlesimi ve denetim turleri olarak yasatilir.",
      ...
      "En iyi statik proje, yalnız emniyet katsayilari saglayan degil, usta, formen ve kontrol muhendisinin aynı sonucu okudugu projedir.",
    ],
    conclusion: [
      ...
      "Bir insaat muhendisi için temel hedef, projeyi yalnız doğru hesaplanmis degil, doğru okunur ve doğru uygulanir hale getirmektir. Bu bakis santiyede revizyonu, kirma-duzeltmeyi ve yapisal kalite kaybini belirgin bicimde azaltir.",
    ],
