...
try {
  ...
  console.log(JSON.stringify({ status: "ok", phase: "FAZ 4 batch 4", routes: slugs.length, checks: completed.length, matrix: "2 routes × 2 themes × 2 viewports", completed }, null, 2));
} finally {
  await browser.close();
