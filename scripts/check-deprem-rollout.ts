...
const EXPECTED_BATCHES: Readonly<Record<DepremRolloutBatch, readonly string[]>> = {
  ...
  7: [
    "asansor-makine-daireli-ve-dairesiz-sistemler", "asansor-guvenlik-aksesuarlari-ve-periyodik-bakim-zorunlulugu",
    "asansor-deprem-sirasinda-otomatik-park-ozelligi", "isg-santiye-guvenlik-plani-zorunlu-icerik",
    "isg-uzmani-gorevlendirme-tehlike-sinifi-isci-sayisi", "isg-yuksekte-calisma-ve-iskele-guvenligi",
    "isg-kazi-guvenligi-iksa-tasarimi-ve-kontrol", "isg-beton-dokumunde-topraklama-ve-elektrik-guvenligi",
    "cevre-ced-zorunlulugu-proje-buyuklugu-esikleri", "cevre-insaat-atigi-yonetimi-yonetmeligi",
    "cevre-gurultu-ve-toz-santiye-yukumlulukleri", "cevre-yagmur-suyu-kirliligi-ve-santiye-filtrasyonu",
  ],
  8: [
    "tbdy-bks-dts-bys-belirleme", "tbdy-performans-hedefleri-dd-sh-kh-go",
    "tbdy-kutle-kaynagi-hareketli-yuk-katilimi", "tbdy-rijit-yari-rijit-diyafram",
    "tbdy-esdeger-deprem-yuku-uygulanma-sinirlari", "tbdy-yeterli-mod-modal-kutle-katilimi",
    "tbdy-modal-taban-kesme-olceklendirme", "tbdy-yuzde-100-yuzde-30-birlesimi",
    "tbdy-dusey-deprem-etkisi", "tbdy-deprem-derzi-hesabi",
    "tbdy-bolum-17-basitlestirilmis-tasarim", "tbdy-uygulama-esaslari-taslak-statusu",
  ],
  9: [
    "tbdy-betonarme-ozel-deprem-etriyesi-ciroz", "tbdy-betonarme-kenetlenme-bindirme-manson-bolgeleri",
    "tbdy-betonarme-kolon-kesit-eksenel-yuk-siniri", "tbdy-betonarme-kolon-boyuna-donati-duzeni",
    "tbdy-betonarme-kolon-sarilma-bolgeleri", "tbdy-betonarme-kolon-kapasite-kesme",
    "tbdy-betonarme-kiris-boyut-eksen-kacikligi", "tbdy-betonarme-kiris-mesnet-donati-surekliligi",
    "tbdy-betonarme-kiris-sarilma-bolgeleri", "tbdy-betonarme-kiris-kapasite-kesme",
    "tbdy-betonarme-kusatilmamis-birlesim", "tbdy-betonarme-birlesim-kesme-guvenligi",
  ],
  10: [
    "tbdy-betonarme-perde-kolon-geometri-ayrimi", "tbdy-betonarme-perde-kritik-yukseklik-uc-bolge",
    "tbdy-betonarme-perde-govde-uc-donati", "tbdy-betonarme-perde-moment-kesme-zarfi",
    "tbdy-betonarme-perde-bosluklari-modelleme", "tbdy-betonarme-diyafram-toplayici-baslik",
    "mevcut-bina-riskli-yapi-ve-bolum-15-farki", "mevcut-bina-bilgi-duzeyleri",
    "mevcut-bina-tasiyici-rolove-hasar-belgeleme", "mevcut-bina-karot-beton-dayanimi",
    "mevcut-bina-donati-tespiti-korozyon", "mevcut-bina-beklenen-dayanim-bilgi-katsayisi",
  ],
};
