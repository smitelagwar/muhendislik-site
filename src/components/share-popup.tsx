      ...
      {open && (
        <>
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[220] bg-black/55 backdrop-blur-sm"
          ...
          <div className="fixed inset-0 z-[221] flex items-end justify-center px-4 pt-10 md:items-center md:pb-4">
            <motion.div
              ...
              className="w-full max-w-lg rounded-t-[2rem] border border-zinc-200 bg-white p-6 shadow-2xl dark:border-zinc-800 dark:bg-zinc-950 md:rounded-[2rem] md:p-8"
            >
