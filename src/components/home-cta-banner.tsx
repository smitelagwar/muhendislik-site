  ...
  return (
    <section className="mx-auto max-w-screen-2xl px-4 py-16 sm:px-6 lg:px-16 lg:py-20">
      <AnimatedSection animation="fade-up">
        <div className="relative isolate overflow-hidden rounded-lg border border-slate-200 dark:border-white/10 bg-[linear-gradient(135deg,rgba(245,158,11,0.18),rgba(6,8,13,0.95)_38%,rgba(8,145,178,0.2)_100%)]">
          ...
          <div className="relative grid gap-8 px-6 py-8 sm:px-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,20rem)] lg:px-10 lg:py-10">
            ...
            <div className="grid gap-4">
              <div className="rounded-lg border border-slate-200 dark:border-white/10 bg-black/20 p-5">
                <div className="flex items-center gap-3 text-sm font-semibold uppercase tracking-[0.16em] text-slate-600 dark:text-slate-300">
                  <SquareTerminal className="h-4 w-4 text-amber-500 dark:text-amber-300" />
                  Beklenen çıktı
                </div>
