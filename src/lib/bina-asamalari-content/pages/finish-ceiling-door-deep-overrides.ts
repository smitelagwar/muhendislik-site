...
const CEILING_TOOLS: BinaGuideTool[] = [
  ...
  { category: "Ölçüm", name: "Lazer nivo, hat ipi ve kot sabitleme cizelgesi", purpose: "Tavan duzlemini göz karariyla değil sayisal olarak kurmak." },
...
const DOOR_TOOLS: BinaGuideTool[] = [
  { category: "Detay", name: "Kapı detayi, esik kesiti ve cephe bağlantı paftası", purpose: "Dış kapının yalnız boşluğu kapatmasini değil kabuga baglanmasini tanimlamak." },
  ...
  { category: "Kayıt", name: "Mahal bazli kapı teslim formu", purpose: "Her dış kapının yön, donanim ve eksiklerini ayri izlemek." },
];

const CEILING_EQUIPMENT: BinaGuideEquipment[] = [
  { group: "Taşıyıcı sistem", name: "Ana taşıyıcı profiller, tali profiller ve aski cubuklari", purpose: "Tavan panellerinin duz ve güvenli tasinacagi karkasi olusturmak.", phase: "Karkas montaji" },
  { group: "Kaplama", name: "Alçıpan veya benzeri tavan levhalari, derz ve dolgu malzemeleri", purpose: "Bitmis yüzey duzlugunu ve estetik surekliligi saglamak.", phase: "Kaplama" },
  ...
  { group: "Kontrol", name: "Lazer kot ekipmani ve numune düğüm seti", purpose: "Karkas ve panel davranisinin teslim öncesi kontrolünü yapmak.", phase: "Kabul" },
];

const DOOR_EQUIPMENT: BinaGuideEquipment[] = [
  { group: "Kapı seti", name: "Dış kapı kasasi, kanat, esik, fitil ve aksesuarlar", purpose: "Aciklikta yalnız kapanis değil hava-su ve güvenlik performansi saglamak.", phase: "Montaj" },
  ...
  { group: "Test", name: "Su testi ekipmani ve ayar donanimi", purpose: "Montaji bitmis kapının yalnız gorunusunu değil performansini da dogrulamak.", phase: "Teslim" },
];
...
export const finishCeilingDoorDeepOverrides: BinaGuidePageSpec[] = [
  {
    ...
    kind: "topic",
    quote: "Asma tavan, mekani gizleyen bir kapak değil; tavandaki tüm teknik kararlarin duzlem, erişim ve estetik disiplinle bir araya geldigi ortak saha ara yuzudur.",
    tip: "Asma tavani yalnız alçıpan kapatma isi gibi görmek, ustundeki tesisat yogunlugunu, servis kapaklarini ve kot toleransini bir anda kontrolsuz bir karmasaya cevirir.",
    intro: [
      "Asma tavan şantiyede cogu zaman sonlara doğru gelen, mekanin gorunusunu toparlayan bir ince iş kalemi gibi dusunulur. Oysa gercekte asma tavan; aydinlatma, sprinkler, menfez, kamera, hoparlor, kablo tavasi ve bazen yangın damperi gibi pek çok teknik kararin alt yuzde okunur hale geldigi ortak bir koordinasyon zonudur. Bu nedenle bir mekanda tavana bakildiginda ne kadar temiz gorunuyorsa, sahada o kadar çok koordinasyon ve disiplin doğru kurulmus demektir.",
      "Sahada en sık problem, tavan karkasinin mekanik ve elektrik disiplinlerinden önce veya onlardan habersiz kurulmasidir. Bu durumda menfezler tavsiye edilen eksenini kaybeder, aydinlatma armaturlari raks eder, sprinkler rozetleri panel merkezini tutmaz, servis gerektiren ekipmanlar ise kapaksiz veya erisimsiz kalir. Sonuc; kes-boz, ek alçı, ikinci montaj ve teslimde göz yoran asimetri olur.",
      "Bir inşaat mühendisi için asma tavan yalnız estetik konu degildir. Tavan kötü, aski boyu, boslukta kalan ekipman agirliklari, yangın kacis elemanlari ve servis kapagi gereksinimi birlikte okunmalidir. Aksi halde tavan duz gorunse bile mekanik veya elektrik isletmesi için problemli hale gelebilir.",
      "Bu yazida asma tavani; teknik teorisi, standart gereksinimleri, sayisal kot ornegi, kullanilan araçlar ve saha hatalariyla birlikte derinlestiriyoruz. Hedef, asma tavani sadece panel kapatma isi değil; tavandaki tüm disiplinleri kullaniciya temiz bir duzlem olarak sunan mühendislik urunu olarak gostermektir.",
    ],
    theory: [
      ...
      "Karkas davranisi burada kritik unsurlerden biridir. Asma tavan panelleri veya alçıpan levhalar kendi basina tavanda asili durmaz; ana ve tali profiller ile aski cubuklari üzerinde tasinir. Profil araliklari, aski düzeni ve çevre kenar profilleri doğru kurulmazsa ilk bakista duz gorunen tavan zamanla sehim, derz catlagi veya ek yeri belirginlesmesi uretir.",
      "Servis erisimi diger temel konudur. Tavanda kalan yangın vanasi, VAV kutusu, elektrik ek kutusu veya kontrol modulu ileride bakım isteyecektir. Tavan kapandi diye bu ekipman yok olmaz. Bu nedenle her cihaz için teknik hacimde yeterli manevra ve gerekli yerde acilir kapak planlanmalidir. Servis kapagi unutulmus bir asma tavan, ileride delinen ve yamalanan bir yuzeye donusur.",
      "Asma tavan aynı zamanda mekan algisini belirler. Koridor, ofis, lobi veya islak hacimde tavan duzlemi farkli isik ve akustik kararlar tasir. Bu nedenle tavan kötü yalnız 'ne kadar yuksekte kalsin' sorusu değil; hangi ekipman nasil saklanacak, hangi aks vurgulanacak ve bakım nasil yapilacak sorulariyla birlikte ele alinmalidir.",
      "Bu bakisla asma tavan, ustteki kargasayi kapatan bir son katman değil; teknik düzeni kullaniciya hissettirmeden yoneten bir organizasyon sistemidir.",
    ],
    ruleTable: [
      {
        parameter: "Taşıyıcı karkas ve aski düzeni",
        ...
        note: "Asma tavan kalitesi yalnız yüzey panelinden değil taşıyıcı sistemden başlar.",
      },
      {
        parameter: "Tavan kötü ve koordinasyon boşluğu",
        limitOrRequirement: "Net tavan kötü, ustteki MEP yoğunluğu ve servis bosluklariyla uyumlu secilmelidir",
        reference: "Reflected ceiling plan + disiplin overlay",
        note: "Tavan yuksekligi teknik boşluk gormeden belirlenmemelidir.",
      },
      {
    ...
    designOrApplicationSteps: [
      ...
      "Acilir kapaklari sonradan eklenen yama gibi değil, planli servis noktası olarak tasarla ve sahaya isle.",
      "Levha kapatma öncesi tavan boslugunu bir kalite kapısı gibi kontrol et; eksik ekipman veya carpisan hat varken tavani kapatma.",
      "Derz, boya alti bitis ve cihaz cevresi detaylarini numune mahal mantigiyla tamamla.",
    ],
    criticalChecks: [
      "Net tavan kötü ustteki tesisat ve servis boşluğu için gercekten yeterli mi?",
      ...
      "Tavan kapatilmadan önce ustteki hatlar son kontrol turunden gecti mi?",
    ],
    numericalExample: {
      title: "Asma tavanda net kot hesabina basit bir yaklasim",
      inputs: [
        { label: "Döşeme alt kötü", value: "3,20 m", note: "Bitmis döşeme ustunden olculen mevcut kot" },
        { label: "En derin mekanik kanal", value: "28 cm", note: "Askilar dahil kritik eleman" },
        { label: "Aydinlatma ve servis boşluğu", value: "10 cm", note: "Bakım ve montaj payi" },
      ...
      steps: [
        {
          title: "Toplam teknik boşluğu bul",
          formula: "28 + 10 + 7 = 45 cm",
          result: "Asma tavan için gerekli toplam boşluk yaklasik 45 cm olur.",
          note: "Bu deger yalnız kanal derinligini değil servis ve karkas payini da icerir.",
        },
        {
        ...
        },
        {
          ...
          note: "Asma tavanda kötü sahada zorlayarak değil, disiplinler arasi koordinasyonla kazanirsiniz.",
        },
      ],
      checks: [
        "Asma tavan kötü tek bir ekipmana göre değil en kritik overlay aksina göre secilmelidir.",
        "Servis boşluğu unutulursa tavan ilk bakimda kirilir veya acilir kapak eklenir.",
        "Karkas kalinligi ve aydinlatma payi genelde gözden kacirilan degerlerdir.",
        "Mimari yükseklik hedefi teknik overlay ile birlikte revize edilmelidir.",
      ],
    ...
    mistakes: [
      ...
      { wrong: "Servis kapaklarini sonradan acilacak delik gibi görmek.", correct: "Bakım ihtiyacini taslakta belirleyip plana islemek." },
      { wrong: "Aydinlatma, sprinkler ve menfezi birbirinden bağımsız yerlestirmek.", correct: "Reflected ceiling plan uzerinden aksli koordinasyon kurmak." },
    ...
    conclusion: [
      ...
      "Bir inşaat mühendisi için en saglam yaklasim, asma tavani alçı kapatma isi değil; tavandaki tüm disiplinlerin kullaniciya temiz bir duzlem olarak sunuldugu teknik arayuz olarak gormektir.",
    ],
  ...
  },
  {
    ...
    kind: "topic",
    quote: "Dış kapı, binaya girilen bir aciklik değil; güvenlik, hava-su kontrolü ve cephe butunlugunun ilk temas noktası olarak calisir.",
    ...
    intro: [
      "Dış kapı bir yapida yalnız geçiş elemani degildir. Gunluk kullanicinin ilk dokundugu detaylardan biri oldugu gibi rüzgar, yağmur, toz, hava kacagi ve güvenlik etkileriyle de doğrudan karsilasan bir kabuk bilesenidir. Bu nedenle estetik algisi yüksek olsa da dış kapının gercek performansi kasa ile duvar arasindaki milimetrelik kararlar, esik detaylari ve donanim secimi tarafindan belirlenir.",
      "Sahada sık gorulen sorunlar genellikle montaj sonrasi hemen fark edilmez. Kapı güzel görünür, kanat acilip kapanir, teslim de yaklasmistir. Ancak ilk siddetli yagmurda esik altindan su gelir, kisin hava kacagi başlar, gunluk kullanimda kanat ayari bozulur ya da kasa çevre mastigi erken yaslanir. Bunun kok nedeni, dış kapının sadece marangozluk kalemi gibi okunmasidir.",
      "Bir inşaat mühendisi için dış kapiyi tanimak, yalnız kanat agirligi veya kasa ebatini bilmek demek degildir. Kapı boslugunun duvarla baglantisi, cephe yalitim tabakasi, esik kötü, suyun yonelecegi detay, emniyet gereksinimi ve acil durumda kullanım senaryosu birlikte dusunulmelidir. Aksi halde iyi urun kötü detayda performansini kaybeder.",
      "Bu yazida dış kapiyi; urun standardi, enerji ve kabuk davranisi, sayisal esik kötü ornegi, kullanilan araçlar ve sık saha hatalariyla birlikte kapsamli bir blog yazisi biciminde ele aliyoruz. Hedef, dış kapının sadece gorunen kanat değil, cephe sisteminin zayif veya guclu halkasi oldugunu gostermektir.",
    ],
    theory: [
      "Dış kapının teorik davranisi uc ana eksende okunur: mekanik çalışma, kabuk performansi ve güvenlik. Mekanik çalışma; kasa, kanat, mentese ve kilit sisteminin defalarca acilip kapanmaya karsi stabil davranmasidir. Kabuk performansi; hava sizdirmazligi, su gecirimsizlik ve isi kaybi kontroludur. Güvenlik ise darbe, zorlanma ve bazen yangın ya da acil çıkış gereksinimi gibi ek beklentileri kapsar.",
      "Kasa ile duvar arasindaki ara yuz burada en kritik bolgelerden biridir. Kapı kasasi ne kadar kaliteli olursa olsun, duvarla baglantisi doğru ankraj, uygun dolgu ve dış hava kosullarina dayanıklı sızdırmazlık katmani ile cozulmemisse toplam performans zayiflar. Dış kapının en zayif noktası cogu zaman urunun kendisi değil, urunun duvara baglandigi çevre detayidir.",
      "Esik ve alt detay da aynı derecede önemlidir. Kullanıcı acisindan konforlu ve güvenli geçiş saglarken suyu iceri almamali, temizlik ve bakimda sorun uretmemelidir. Yanlış esik detayi ilk bakista goze batmaz; fakat yağmur, yikama suyu ya da ruzgarla suruklenen su etkisinde hizla kendini belli eder. Bu nedenle dış kapı esigi mimari bitisle değil su davranisiyla birlikte okunmalidir.",
      ...
      "Doğru dış kapı uygulamasi, urun secimi kadar montaj detayina baglidir. Iyi urun kötü montajla cabuk yipranir; orta seviye urun bile temiz detayla daha uzun omurlu davranabilir. Mühendislik bakisi bu nedenle kapının katalog degerinden çok saha ara yuzune odaklanir.",
    ],
    ruleTable: [
      {
        ...
        note: "Dış kapının urun standardi yalnız ebat değil performans beklentisi tarif eder.",
      },
      {
        parameter: "Esik ve su yonu detayi",
        limitOrRequirement: "Esik, yağmur suyu ve yikama suyu iceri yonlenmeyecek sekilde kot ve detayla çözülmelidir",
      ...
      },
      {
        ...
        reference: "Mimari kullanıcı senaryosu + yangın gereksinimleri",
        note: "Ana giriş, teknik hacim ve çıkış kapıları aynı beklentiye sahip degildir.",
      },
    ],
    designOrApplicationSteps: [
      "Dış kapı tipini cephe maruziyeti, kullanım yoğunluğu ve güvenlik ihtiyacina göre belirle; iç kapı mantigiyla urun secme.",
      "Kapı boslugunu kaba aciklik olarak değil, bitmis cephe ve zemin kotlariyla birlikte yeniden olc.",
      ...
      "Teslim öncesi su testi ve detay kontrolü yaparak mastik ve fitil performansini kayda bagla.",
    ],
    criticalChecks: [
    ...
    numericalExample: {
      title: "Dış kapı esik kotunda su güvenliği yorumu",
      inputs: [
        { label: "Dış zemin kötü", value: "+0,00", note: "Referans yaya giriş kötü" },
        { label: "İç bitmis döşeme kötü", value: "+0,05 m", note: "İç mekanda 5 cm yukari seviye" },
        { label: "Esik üst kötü", value: "+0,03 m", note: "Mevcut montaj karari" },
        { label: "Hedef", value: "Yagmur suyuna karsi alt detay riskini yorumlamak", note: "Kavramsal saha kontrolü" },
      ],
      assumptions: [
        "Dış zeminde yağmur suyunu uzaklastiran ek bir oluk detayi bulunmadigi varsayilmistir.",
      ...
      steps: [
        {
          ...
          note: "Yüksek maruziyetli bir noktada bu fark tek basina her zaman yeterli olmayabilir.",
        },
        {
          title: "İç mekan kotuyla karsilastir",
          formula: "+0,05 - +0,03 = 2 cm",
          result: "İç bitmis döşeme esikten 2 cm yuksektir; suyun iceri girmesi halinde tampon alan sinirlidir.",
          note: "Detay yalnız yürüme konforu değil su güvenliği acisindan da okunmalidir.",
        },
        {
          title: "Mühendislik kararini bagla",
          result: "Esik kötü, dış zemin egimi ve gerekirse oluk veya su kesici detayla birlikte yeniden çözülmelidir.",
      ...
      checks: [
        ...
        "Yagmur maruziyeti yüksek cephelerde küçük kot farklari yeterli olmayabilir.",
        "Kasa fitili ile esik detayi birbirini tamamlayan iki farkli koruma katmanidir.",
        "Su testini yalnız kanat cevresinde değil alt detayda yogunlastirmak gerekir.",
      ],
    ...
    mistakes: [
      ...
      { wrong: "Su testini atlayip yalnız acilma-kapanma kontrolü yapmak.", correct: "Performansi hava ve su acisindan da dogrulamak." },
    ...
    designVsField: [
      "Projede dış kapı bir sembol ve ebat tablosudur; sahada ise rüzgar, yağmur, güvenlik ve gunluk kullanım aynı anda kapının uzerine biner.",
    ...
    conclusion: [
      ...
      "Bir inşaat mühendisi için en doğru bakis, dış kapının dekoratif bir tamamlayici değil; cephe butunlugunun ve kullanıcı guvenliginin aktif bir parçası oldugunu kabul etmektir.",
    ],
