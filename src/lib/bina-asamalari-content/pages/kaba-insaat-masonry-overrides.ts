...
const MASONRY_TOOLS: BinaGuideTool[] = [
  { category: "Cizim", name: "Mimari aks, bosluk ve modul paftalari", purpose: "Duvar eksenini, lento kararini ve kesim noktalarini uygulama öncesi netlestirmek." },
...
const MASONRY_EQUIPMENT: BinaGuideEquipment[] = [
  { group: "Malzeme", name: "Tugla veya briket birimleri, orgu harci ve yardimci bağlantı elemanlari", purpose: "Dolgu duvari doğru modul ve derz düzeniyle kurmak.", phase: "Duvar orumu" },
  { group: "Ölçüm", name: "Şakul, lazer, metre ve derz kontrol ekipmanlari", purpose: "Aks, dusaylik ve bitis bosluklarini sürekli takip etmek.", phase: "Surekli kontrol" },
  ...
  { group: "Koordinasyon", name: "Lento, ankraj, kilif ve geçiş parcalari", purpose: "Acikliklari ve betonarme-temas detaylarini guvenli ve temiz tamamlamak.", phase: "Detay ve koordinasyon" },
];
...
export const kabaInsaatMasonryOverrides: BinaGuidePageSpec[] = [
  {
    ...
    intro: [
      ...
      "Sahada tugla duvarla ilgili en sık görülen problemler; duvar düzleminin dalgalanmasi, derz ritminin bozulmasi, açiklik kenarlarinda zayif ve kırik parçalar birakilmasi, kolon temaslarinda catlak ve tesisat için sonradan gelişi güzel kirim yapilmasidir. Bu hatalarin çoğu malzeme seciminden değil, uygulama sırasının disiplinli kurgulanmamasından doğar.",
      "Bir insaat muhendisi için tugla duvar, taşıyıcı olmayan ikincil iş gibi görünse de bitiş kalitesini, doğrama montajini, siva kalınlığını ve tesisat koordinasyonunu doğrudan etkiler. Kötü örülmüş bir tugla duvar kendini o gün değil, sonraki tüm ekipler geldikçe belli eder.",
      "Bu nedenle tugla duvar işini yalnız usta alışkanlığına bırakmak yerine, aks, modul, derz, boşluk ve birleşim detayları açısından sistematik biçimde yönetmek gerekir.",
    ],
    theory: [
      ...
      "Ayrıca tugla duvar, tesisat için en çok müdahale gören dolgu tiplerinden biridir. Plansız buat ve kanal kirimlari, duvarın düzenini ve yüzey kalitesini hizla bozar. Bu nedenle tugla duvar işi, elektrik ve mekanik ekipleriyle birlikte planlanan bir koordinasyon imalatı olarak ele alınmalıdır.",
    ],
    ruleTable: [
      {
        parameter: "Derz ritmi ve modul",
        limitOrRequirement: "Yatay ve düşey derz duzeni duvar boyunca kontrollu ve tekrarlanabilir olmali",
      ...
      },
      {
        ...
        limitOrRequirement: "Doğrama bosluklari siva ve montaj payi birlikte dusunulerek tamamlanmali",
    ...
    numericalExample: {
      title: "4,20 m duvarda kapı boslugu etrafinda modul karari",
      inputs: [
        { label: "Toplam duvar boyu", value: "420 cm", note: "İç mekan tugla duvari" },
        { label: "Kapı kaba boslugu", value: "90 cm", note: "Doğrama öncesi açiklik" },
      ...
      assumptions: [
        ...
        "Doğrama olcusu kesinlesmistir ve bosluk revizyonu imkani sınırlıdır.",
      ],
      steps: [
        {
      ...
      engineeringComment: "Tugla duvarda birkaç santimetrelik kesim karari, sonradan doğrama ve siva ekibinin gunlerini etkileyebilir.",
    },
    tools: MASONRY_TOOLS,
    ...
    mistakes: [
      ...
      { wrong: "Tesisat için duvar bittikten sonra rastgele kanal kirimak.", correct: "Gecisleri duvar orumu ile birlikte planlamak." },
      { wrong: "Kolon-duvar temasini küçük detay saymak.", correct: "Malzeme degisim hattini catlak riski olarak ayri takip etmek." },
    ...
    designVsField: [
      "Projede tugla duvar bir tarama alanı gibi görünür; sahada ise doğrama, tesisat ve siva toleranslarini tasiyan hassas bir koordinasyon yüzeyidir.",
    ...
    conclusion: [
      "Tugla duvar doğru modul, doğru derz ve doğru koordinasyonla uygulandiginda temiz, okunabilir ve bitiş ekiplerini zorlamayan bir dolgu duvar üretir. Aynı iş disiplin kaybettiginde ince işlerde en çok düzeltme isteyen yüzeylerden birine dönüşür.",
  ...
  },
  {
    ...
    tip: "Brikette sorun sadece yüzey dalgasi degildir; kötü kesim, zayif alt sira ve sonradan acilan kanallar duvarin butun mantigini bozar.",
    intro: [
      ...
      "Bir insaat muhendisi için briket duvarın önemi, yalnız metraj veya hız hesabı değildir. Briket duvar, döşeme üstündeki ek yükü, akustik beklentiyi, sıva davranışını ve mekanik-elektrik koordinasyonunu birlikte etkiler. Bu yüzden uygulama kalitesi kadar planlama kalitesi de kritik hale gelir.",
    ...
    conclusion: [
      "Briket duvar doğru modul, doğru ilk sira ve doğru koordinasyon ile uygulandiginda temiz, sağlam görünen ve bitiş ekiplerini yormayan bir yüzey üretir. Plansız ilerlediğinde ise özellikle boşluk çevresi ve tesisat müdahalelerinde hızlı kalite kaybı yaşanır.",
