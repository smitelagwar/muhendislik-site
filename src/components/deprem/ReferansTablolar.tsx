    ...
    <section className="py-12 px-6 bg-gray-950/50 border-y border-gray-800">
      <div className="max-w-7xl mx-auto space-y-8">
        <h2 className="text-2xl font-bold text-gray-100 flex items-center gap-2">
          <span className="h-6 w-1 rounded-sm bg-blue-500"></span>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-1">
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="bks" className="border-gray-800 px-4">
              <AccordionTrigger className="text-gray-200 hover:text-blue-300">
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow className="border-gray-800 hover:bg-gray-800/50">
                        <TableCell className="font-mono text-amber-400">3</TableCell>
                      ...
                      <TableRow className="border-gray-800 hover:bg-gray-800/50">
                        <TableCell className="font-mono text-amber-400">2</TableCell>
                      ...
                      <TableRow className="border-gray-800 hover:bg-gray-800/50">
                        <TableCell className="font-mono text-amber-400">1</TableCell>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      <TableRow className="border-gray-800 hover:bg-gray-800/50">
                        ...
                        <TableCell className="text-amber-400">Göçmenin Önlenmesi (GÖ) / Kontrollü Hasar (KH)*</TableCell>
                      </TableRow>
                      <TableRow className="border-gray-800 hover:bg-gray-800/50">
                        <TableCell className="font-medium text-gray-300">DD-2 (50 yılda aşılma 710, Tekrarlanma 475 yıl)</TableCell>
                        <TableCell className="text-amber-400">Kontrollü Hasar (KH) [Tasarım Depremi]</TableCell>
                      ...
                      <TableRow className="border-gray-800 hover:bg-gray-800/50">
                        ...
                        <TableCell className="text-amber-400">Sınırlı Hasar (SH)</TableCell>
                      </TableRow>
                      <TableRow className="border-gray-800 hover:bg-gray-800/50">
